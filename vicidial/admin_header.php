<?php
# admin_header.php - Administration header
# Logo removed while preserving all settings
...
# Load custom color scheme if specified
...
# Set color variables for header
 $Mhead_color = $SSstd_row5_background;
 $Mmain_bgcolor = $SSmenu_background;

# Set default generic logo (replacing VICIdial logo)
 $selected_logo = "./images/generic_admin_logo.png";
 $selected_small_logo = "./images/generic_admin_logo_small.png";

# Check if custom logo exists and use it if specified
 $logo_new=0;
 $logo_old=0;
 $logo_small_old=0;
if (file_exists('./images/generic_admin_logo.png')) {$logo_new++;}
if (file_exists('generic_admin_logo_small.gif')) {$logo_small_old++;}
if (file_exists('generic_admin_logo.gif')) {$logo_old++;}
...
{
    $selected_logo = "./generic_admin_logo.gif";
    $selected_small_logo = "./images/generic_admin_logo_small.gif";
}
if ( ($SSweb_logo!='default_new') and ($SSweb_logo!='default_old') )
{
    if (file_exists("./images/generic_admin_logo$SSweb_logo")) 
    {
        $selected_logo = "./images/generic_admin_logo$SSweb_logo";
        $selected_small_logo = "./images/generic_admin_logo$SSweb_logo";
    }
}
...
else
{
    ...
    if ( ($ADD==3511) or ($ADD==2511) or ($ADD==2611) or ($ADD==4511) or ($ADD==5511) )
    {
        ...
        ?>
        // Call Menu option value entries
    ...
    /* Top Navigation Bar */
    .top-nav {
        background-color: #1a3a5f; /* Dark blue */
        color: white;
        height: 60px;
        display: flex;
        align-items: center;
    ...
    .top-nav-submenu-item:hover .top-nav-submenu-dropdown {
        display: block;
    }
    
    .top-nav-submenu-dropdown-item {
        padding: 10px 15px;
        border-bottom: 1px solid rgba(255,255,255,0.1);
    }
    
    .top-nav-submenu-dropdown-item:last-child {
        border-bottom: none;
    }
    
    .top-nav-submenu-dropdown-link {
        color: white;
        text-decoration: none;
        display: block;
    }
    
    .top-nav-submenu-dropdown-link:hover {
    ...
    * html .diff span{
    ...
    <div class="top-nav">
        <div class="top-nav-left">
            ...
            <a href="<?php echo $ADMIN ?>"><img src="<?php echo $selected_small_logo; ?>" height="30" alt="System logo"></a>
            <div class="top-nav-submenu">
                ...
                if ( ($reports_only_user < 1) and ($qc_only_user < 1) )
                {
                    ...
                    <div class="top-nav-submenu-item">
                        <a href="<?php echo $ADMIN ?>?ADD=0A" class="top-nav-submenu-link">
                            <?php echo $users_icon ?> Users
                        </a>
                        <div class="top-nav-submenu-dropdown">
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=0A" class="top-nav-submenu-dropdown-link">Show Users</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1" class="top-nav-submenu-dropdown-link">Add New User</a>
                            </div>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1A" class="top-nav-submenu-dropdown-link">Copy User</a>
                            </div>
                            <?php } ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=550" class="top-nav-submenu-dropdown-link">Search For User</a>
                            </div>
                        </div>
                    </div>
                    <div class="top-nav-submenu-item">
                        <a href="<?php echo $ADMIN ?>?ADD=10" class="top-nav-submenu-link">
                            <?php echo $campaigns_icon ?> Campaigns
                        </a>
                        <div class="top-nav-submenu-dropdown">
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=10" class="top-nav-submenu-dropdown-link">Show Campaigns</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=11" class="top-nav-submenu-dropdown-link">Add New Campaign</a>
                            </div>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=12" class="top-nav-submenu-dropdown-link">Copy Campaign</a>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="top-nav-submenu-item">
                        <a href="<?php echo $ADMIN ?>?ADD=100" class="top-nav-submenu-link">
                            <?php echo $lists_icon ?> Lists
                        </a>
                        <div class="top-nav-submenu-dropdown">
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=100" class="top-nav-submenu-dropdown-link">Show Lists</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=111" class="top-nav-submenu-dropdown-link">Add New List</a>
                            </div>
                            <?php } ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="admin_search_lead.php" class="top-nav-submenu-dropdown-link">Search For Lead</a>
                            </div>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="admin_modify_lead.php" class="top-nav-submenu-dropdown-link">Add New Lead</a>
                            </div>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="./admin_listloader_fourth_gen.php" class="top-nav-submenu-dropdown-link">Load New Leads</a>
                            </div>
                        </div>
                    </div>
                    <div class="top-nav-submenu-item">
                        <a href="<?php echo $ADMIN ?>?ADD=1001" class="top-nav-submenu-link">
                            <?php echo $inbound_icon ?> Inbound
                        </a>
                        <div class="top-nav-submenu-dropdown">
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1000" class="top-nav-submenu-dropdown-link">Show In-Groups</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1111" class="top-nav-submenu-dropdown-link">Add New In-Group</a>
                            </div>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1211" class="top-nav-submenu-dropdown-link">Copy In-Group</a>
                            </div>
                            <?php } ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1300" class="top-nav-submenu-dropdown-link">Show DIDs</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=1311" class="top-nav-submenu-dropdown-link">Add New DID</a>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="top-nav-submenu-item">
                        <a href="<?php echo $ADMIN ?>?ADD=999998" class="top-nav-submenu-link">
                            <?php echo $admin_icon ?> Admin
                        </a>
                        <div class="top-nav-submenu-dropdown">
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=10000000000" class="top-nav-submenu-dropdown-link">Phones</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=11111111111" class="top-nav-submenu-dropdown-link">Add New Phone</a>
                            </div>
                            <?php } ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=140000000000" class="top-nav-submenu-dropdown-link">Carriers</a>
                            </div>
                            <?php if ($add_copy_disabled < 1) { ?>
                            <div class="top-nav-submenu-dropdown-item">
                                <a href="<?php echo $ADMIN ?>?ADD=141111111111" class="top-nav-submenu-dropdown-link">Add New Carrier</a>
                            </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                else
                {
                    if ($reports_only_user > 0)
                    {
                        ?>
                        <div class="top-nav-submenu-item">
                            <a href="<?php echo $ADMIN ?>?ADD=999999" class="top-nav-submenu-link">
                                <?php echo $reports_icon ?> Reports
                            </a>
                        </div>
                        <?php
                    }
                    else
                    {
                        if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
                        {
                            ?>
                            <div class="top-nav-submenu-item">
                                <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="top-nav-submenu-link">
                                    <?php echo $qc_icon ?> Quality Control
                                </a>
                            </div>
                            <?php
                        }
        ...
        <div class="top-nav-right">
            <a href="<?php echo $admin_home_url_LU ?>" class="top-nav-link">HOME</a>
            <a href="../agc/timeclock.php?referrer=admin" class="top-nav-link">Timeclock</a>
            <a href="manager_chat_interface.php" class="top-nav-link">Chat</a>
            <a href="<?php echo $ADMIN ?>?force_logout=1" class="top-nav-link">Logout</a>
            <div class="user-info"><?php echo $PHP_AUTH_USER ?></div>
        </div>
    </div>

    <div id="sidebar" class="sidebar">
        <div class="sidebar-header">
            <img src="<?php echo $selected_logo; ?>" class="sidebar-logo" alt="System logo">
            <h3><?php echo _QXZ("ADMINISTRATION"); ?></h3>
        </div>
        <ul class="sidebar-menu">
            ...
            ?>
            <!-- REPORTS NAVIGATION -->
            <li class="menu-item <?php if (strlen($reports_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $reports_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $reports_icon ?> <?php echo _QXZ("Reports"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=999999"><?php echo _QXZ("Reports Main"); ?></a></div>
                </div>
            </li>

            <!-- USERS NAVIGATION -->
            <li class="menu-item <?php if (strlen($users_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $users_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $users_icon ?> <?php echo _QXZ("Users"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=0A"><?php echo _QXZ("Show Users"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1"><?php echo _QXZ("Add A New User"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1A"><?php echo _QXZ("Copy User"); ?></a></div>
                    <?php } ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=550"><?php echo _QXZ("Search For A User"); ?></a></div>
                    <div class="submenu-item"><a href="./user_stats.php?user=<?php echo $user ?>"><?php echo _QXZ("User Stats"); ?></a></div>
                    <div class="submenu-item"><a href="./user_status.php?user=<?php echo $user ?>"><?php echo _QXZ("User Status"); ?></a></div>
                    <div class="submenu-item"><a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>"><?php echo _QXZ("Time Sheet"); ?></a></div>
                    <?php
                    if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
                    { ?>
                    <div class="submenu-item"><a href="./user_territories.php?agent=<?php echo $user ?>"><?php echo _QXZ("User Territories"); ?></a></div>
                    <?php }
                    if ($SSuser_new_lead_limit > 0)
                    { ?>
                    <div class="submenu-item"><a href="./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall"><?php echo _QXZ("Overall New Lead Limits"); ?></a></div>
                    <?php } ?>
                </div>
            </li>
            <!-- CAMPAIGNS NAVIGATION -->
            <li class="menu-item <?php if (strlen($campaigns_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $campaigns_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $campaigns_icon ?> <?php echo _QXZ("Campaigns"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=10"><?php echo _QXZ("Campaigns Main"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=32"><?php echo _QXZ("Statuses"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=33"><?php echo _QXZ("HotKeys"); ?></a></div>
                    <?php
                    if ($SSoutbound_autodial_active > 0)
                    {
                        ?>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=35"><?php echo _QXZ("Lead Recycle"); ?></a></div>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=36"><?php echo _QXZ("Auto-Alt Dial"); ?></a></div>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=39"><?php echo _QXZ("List Mix"); ?></a></div>
                        <?php
                    }
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=37"><?php echo _QXZ("Pause Codes"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=301"><?php echo _QXZ("Presets"); ?></a></div>
                    <?php
                    if ($SScampaign_cid_areacodes_enabled > 0)
                    {
                        ?>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=302"><?php echo _QXZ("AC-CID"); ?></a></div>
                        <?php
                    }
                    ?>
                </div>
            ...
            {
                ?>
                <li class="menu-item <?php if (strlen($lists_hh) > 25) echo 'expanded'; ?>">
                    <div class="menu-item-header <?php echo $lists_hh ?>" onclick="toggleMenuItem(this)">
                        <span><?php echo $lists_icon ?> <?php echo _QXZ("Lists"); ?></span>
                        <span class="menu-item-arrow">▶</span>
                    </div>
                    <div class="submenu">
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100"><?php echo _QXZ("Show Lists"); ?></a></div>
                        <?php if ($add_copy_disabled < 1) { ?>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=111"><?php echo _QXZ("Add A New List"); ?></a></div>
                        <?php } ?>
                        <div class="submenu-item"><a href="admin_search_lead.php"><?php echo _QXZ("Search For A Lead"); ?></a></div>
                        <div class="submenu-item"><a href="admin_modify_lead.php"><?php echo _QXZ("Add A New Lead"); ?></a></div>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=121"><?php echo $DNClink ?></a></div>
                        <div class="submenu-item"><a href="./admin_listloader_fourth_gen.php"><?php echo _QXZ("Load New Leads"); ?></a></div>
                        <?php
                        if ($SScustom_fields_enabled > 0)
                        {
                            $admin_lists_custom = 'admin_lists_custom.php';
                            ?>
                            <div class="submenu-item"><a href="./<?php echo $admin_lists_custom ?>"><?php echo _QXZ("List Custom Fields"); ?></a></div>
                            <div class="submenu-item"><a href="./<?php echo $admin_lists_custom ?>?action=COPY_FIELDS_FORM"><?php echo _QXZ("Copy Custom Fields"); ?></a></div>
                            <?php
                        }
                        if ($SSenable_drop_lists > 0)
                        {
                            ?>
                            <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=130"><?php echo _QXZ("Drop Lists"); ?></a></div>
                            <?php
                        }
                        ?>
                    </div>
            ...
            { ?>
            <!-- QC navigation -->
            <li class="menu-item <?php if (strlen($qc_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $qc_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $qc_icon ?> <?php echo _QXZ("Quality Control"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=CAMPAIGN"><?php echo _QXZ("QC Calls by Campaign"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=LIST"><?php echo _QXZ("QC Calls by List"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=INGROUP"><?php echo _QXZ("QC Calls by Ingroup"); ?></a></div>
                    <div class="submenu-item"><a href="qc_scorecards.php"><?php echo _QXZ("Show QC Scorecards"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=341111111111111"><?php echo _QXZ("Modify QC Codes"); ?></a></div>
                </div>
            </li>
            <?php }
            ?>
            <!-- SCRIPTS NAVIGATION -->
            <li class="menu-item <?php if (strlen($scripts_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $scripts_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $scripts_icon ?> <?php echo _QXZ("Scripts"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1000000"><?php echo _QXZ("Show Scripts"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1111111"><?php echo _QXZ("Add A New Script"); ?></a></div>
                    <?php } ?>
                </div>
            </li>
            <!-- FILTERS NAVIGATION -->
            ...
            {
                ?>
                <li class="menu-item <?php if (strlen($filters_hh) > 25) echo 'expanded'; ?>">
                    <div class="menu-item-header <?php echo $filters_hh ?>" onclick="toggleMenuItem(this)">
                        <span><?php echo $filters_icon ?> <?php echo _QXZ("Filters"); ?></span>
                        <span class="menu-item-arrow">▶</span>
                    </div>
                    <div class="submenu">
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=10000000"><?php echo _QXZ("Show Filters"); ?></a></div>
                        <?php if ($add_copy_disabled < 1) { ?>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=11111111"><?php echo _QXZ("Add A New Filter"); ?></a></div>
                        <?php } ?>
                    </div>
                </li>
                <?php
            ...
            ?>
            <!-- INGROUPS NAVIGATION -->
            <li class="menu-item <?php if (strlen($ingroups_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $ingroups_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $inbound_icon ?> <?php echo _QXZ("Inbound"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1000"><?php echo _QXZ("Show In-Groups"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1111"><?php echo _QXZ("Add A New In-Group"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1211"><?php echo _QXZ("Copy In-Group"); ?></a></div>
                    <?php } ?>
                    <?php
                    if ($SSemail_enabled>0) 
                    {
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1800"><?php echo _QXZ("Show Email Groups"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1811"><?php echo _QXZ("Add New Email Group"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1911"><?php echo _QXZ("Copy Email Group"); ?></a></div>
                    <?php } ?>
                    <?php
                    }
                    ?>
                    ...
                    {
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1900"><?php echo _QXZ("Show Chat Groups"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=18111"><?php echo _QXZ("Add New Chat Group"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=19111"><?php echo _QXZ("Copy Chat Group"); ?></a></div>
                    <?php } ?>
                    <?php
                    }
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1300"><?php echo _QXZ("Show DIDs"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1311"><?php echo _QXZ("Add A New DID"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1411"><?php echo _QXZ("Copy DID"); ?></a></div>
                    <?php } ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1500"><?php echo _QXZ("Show Call Menus"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1511"><?php echo _QXZ("Add A New Call Menu"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1611"><?php echo _QXZ("Copy Call Menu"); ?></a></div>
                    <?php } ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1700"><?php echo _QXZ("Filter Phone Groups"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1711"><?php echo _QXZ("Add Filter Phone Group"); ?></a></div>
                    <?php } ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=171"><?php echo $FPGlink ?></a></div>
                </div>
            </li>
            <!-- USERGROUPS NAVIGATION -->
            <li class="menu-item <?php if (strlen($usergroups_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $usergroups_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $usergroups_icon ?> <?php echo _QXZ("User Groups"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000"><?php echo _QXZ("Show User Groups"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=111111"><?php echo _QXZ("Add A New User Group"); ?></a></div>
                    <?php } ?>
                    <div class="submenu-item"><a href="group_hourly_stats.php"><?php echo _QXZ("Group Hourly Report"); ?></a></div>
                    <div class="submenu-item"><a href="user_group_bulk_change.php"><?php echo _QXZ("Bulk Group Change"); ?></a></div>
                </div>
            </li>
            <!-- REMOTEAGENTS NAVIGATION -->
            <li class="menu-item <?php if (strlen($remoteagent_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $remoteagent_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $remoteagents_icon ?> <?php echo _QXZ("Remote Agents"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=10000"><?php echo _QXZ("Show Remote Agents"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=11111"><?php echo _QXZ("Add New Remote Agents"); ?></a></div>
                    <?php } ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=12000"><?php echo _QXZ("Show Extension Groups"); ?></a></div>
                    <?php if ($add_copy_disabled < 1) { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=12111"><?php echo _QXZ("Add Extension Group"); ?></a></div>
                    <?php } ?>
                </div>
            </li>
            <!-- ADMIN NAVIGATION -->
            <li class="menu-item <?php if (strlen($admin_hh) > 25) echo 'expanded'; ?>">
                <div class="menu-item-header <?php echo $admin_hh ?>" onclick="toggleMenuItem(this)">
                    <span><?php echo $admin_icon ?> <?php echo _QXZ("Admin"); ?></span>
                    <span class="menu-item-arrow">▶</span>
                </div>
                <div class="submenu">
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000"><?php echo _QXZ("Call Times"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=130000000"><?php echo _QXZ("Shifts"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=10000000000"><?php echo _QXZ("Phones"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=130000000000"><?php echo _QXZ("Templates"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=140000000000"><?php echo _QXZ("Carriers"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000"><?php echo _QXZ("Servers"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=1000000000000"><?php echo _QXZ("Conferences"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=311111111111111"><?php echo _QXZ("System Settings"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=180000000000"><?php echo _QXZ("Screen Labels"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=182000000000"><?php echo _QXZ("Screen Colors"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=321111111111111"><?php echo _QXZ("System Statuses"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=193000000000"><?php echo _QXZ("Status Groups"); ?></a></div>
                    <?php
                    if ($SScampaign_cid_areacodes_enabled > 0)
                    {
                        ?>
                        <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=196000000000"><?php echo _QXZ("CID Groups"); ?></a></div>
                        <?php
                    }
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=170000000000"><?php echo _QXZ("Voicemail"); ?></a></div>
                    <?php
                    if ($SSemail_enabled > 0)
                    { ?>
                    <div class="submenu-item"><a href="admin_email_accounts.php"><?php echo _QXZ("Email Accounts"); ?></a></div>
                    <?php }
                    if ( ($sounds_central_control_active > 0) or ($SSsounds_central_control_active > 0) )
                        { ?>
                    <div class="submenu-item"><a href="audio_store.php"><?php echo _QXZ("Audio Store"); ?></a></div>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=160000000000"><?php echo _QXZ("Music On Hold"); ?></a></div>
                    <?php
                    if ($SSenable_languages > 0)
                            { ?>
                    <div class="submenu-item"><a href="admin_languages.php?ADD=163000000000"><?php echo _QXZ("Languages"); ?></a></div>
                    <?php }
                    if ( (preg_match("/soundboard/",$SSactive_modules) ) or ($SSagent_soundboards > 0) )
                        {
                    ?>
                    <div class="submenu-item"><a href="admin_soundboard.php?ADD=162000000000"><?php echo _QXZ("Audio Soundboards"); ?></a></div>
                    <?php 
                        }

                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=197000000000"><?php echo _QXZ("VM Message Groups"); ?></a></div>
                    <?php 
                        }
                    if ($SSenable_tts_integration > 0)
                        { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=150000000000"><?php echo _QXZ("Text To Speech"); ?></a></div>
                    <?php }
                    if ($SScallcard_enabled > 0)
                        { ?>
                    <div class="submenu-item"><a href="callcard_admin.php"><?php echo _QXZ("CallCard Admin"); ?></a></div>
                    <?php }
                    if ($SScontacts_enabled > 0)
                        { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=190000000000"><?php echo _QXZ("Contacts"); ?></a></div>
                    <?php }
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=192000000000"><?php echo _QXZ("Settings Containers"); ?></a></div>
                    <?php
                    if ($SSenable_auto_reports > 0)
                        { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=194000000000"><?php echo _QXZ("Automated Reports"); ?></a></div>
                    <?php }
                    if ($SSallow_ip_lists > 0)
                        { ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=195000000000"><?php echo _QXZ("IP Lists"); ?></a></div>
                    <?php }
                    ?>
                    <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=198000000000"><?php echo _QXZ("Queue Groups"); ?></a></div>
                </div>
            </li>
            <?php
            }
            else
            {
                ...
                else
                {
                    ...
                    <li class="menu-item <?php if (strlen($qc_hh) > 25) echo 'expanded'; ?>">
                        ...
                        <div class="submenu">
                            <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000000"><?php echo _QXZ("Show QC Campaigns"); ?></a></div>
                            <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=100000000000000"><?php echo _QXZ("Enter QC Queue"); ?></a></div>
                            <div class="submenu-item"><a href="<?php echo $ADMIN ?>?ADD=341111111111111"><?php echo _QXZ("Modify QC Codes"); ?></a></div>
                        </div>
                    </li>
                    <?php
    ...
    <div id="sidebar-overlay" class="sidebar-overlay" onclick="closeSidebarOverlay()"></div>
