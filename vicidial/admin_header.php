                ...
                <div class="header-container">
                    ...
                    <nav class="header-nav">
                        ...
                        if (($reports_only_user < 1) && ($qc_only_user < 1)) {
                            ?>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=999999'); ?>" class="nav-link" title="Reports">
                                <?php echo $reports_icon; ?> <span><?php echo _QXZ("Reports"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=0A'); ?>" class="nav-link" title="Users">
                                <?php echo $users_icon; ?> <span><?php echo _QXZ("Users"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=10'); ?>" class="nav-link" title="Campaigns">
                            ...
                            if (($SSqc_features_active == '1') && ($qc_auth == '1')) {
                                ?>
                                <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=100000000000000'); ?>" class="nav-link" title="Quality Control">
                                    <?php echo $qc_icon; ?> <span><?php echo _QXZ("Quality Control"); ?></span>
                                </a>
                                <?php
                            }
                            ?>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=100'); ?>" class="nav-link" title="Lists">
                                <?php echo $lists_icon; ?> <span><?php echo _QXZ("Lists"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=1000000'); ?>" class="nav-link" title="Scripts">
                                <?php echo $scripts_icon; ?> <span><?php echo _QXZ("Scripts"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=10000000'); ?>" class="nav-link" title="Filters">
                                <?php echo $filters_icon; ?> <span><?php echo _QXZ("Filters"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=1001'); ?>" class="nav-link" title="Inbound">
                                <?php echo $inbound_icon; ?> <span><?php echo _QXZ("Inbound"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=100000'); ?>" class="nav-link" title="User Groups">
                                <?php echo $usergroups_icon; ?> <span><?php echo _QXZ("User Groups"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=10000'); ?>" class="nav-link" title="Remote Agents">
                                <?php echo $remoteagents_icon; ?> <span><?php echo _QXZ("Remote Agents"); ?></span>
                            </a>
                            <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=999998'); ?>" class="nav-link" title="Admin">
                        ...
                        // Limited access menu
                            ...
                            if ($reports_only_user > 0) {
                                ?>
                                <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=999999'); ?>" class="nav-link active" title="Reports">
                                ...
                                if (($SSqc_features_active == '1') && ($qc_auth == '1')) {
                                    ?>
                                    <a href="<?php echo htmlspecialchars($ADMIN . '?ADD=100000000000000'); ?>" class="nav-link active" title="Quality Control">
    ...
    <header class="modern-header">
        <div class="header-container">
            ...
            <div class="header-nav">
                <a href="admin_mobile.php?ADD=999990" class="nav-link" title="Admin">
                    <?php echo $admin_icon; ?> <span><?php echo _QXZ("Admin"); ?></span>
                </a>
            </div>
        </div>
...
.sidebar {
  width: 220px;
  background: linear-gradient(180deg, #<?php echo $SSmenu_background; ?>, #<?php echo $SSmenu_background; ?>dd);
  color: white;
  padding: 20px 0;
...
<div class="admin-container">
  ...
  <div class="sidebar">
    ...
    <div class="nav-section">
      ...
      ?>
      <!-- REPORTS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=999999" class="nav-item <?php echo strpos($reports_hh, 'selected') !== false ? 'active' : ''; ?>">
        <?php echo $reports_icon; ?> <?php echo _QXZ("Reports"); ?>
      </a>

      <!-- USERS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=0A" class="nav-item <?php echo strpos($users_hh, 'selected') !== false ? 'active' : ''; ?>">
        <?php echo $users_icon; ?> <?php echo _QXZ("Users"); ?>
      </a>
      <?php
      if (strlen($users_hh) > 25) 
        { 
        $list_sh = (strpos($list_sh, 'selected') !== false) ? 'active' : '';
        $new_sh = (strpos($new_sh, 'selected') !== false) ? 'active' : '';
        $copy_sh = (strpos($copy_sh, 'selected') !== false) ? 'active' : '';
        $search_sh = (strpos($search_sh, 'selected') !== false) ? 'active' : '';
        $stats_sh = (strpos($stats_sh, 'selected') !== false) ? 'active' : '';
        $status_sh = (strpos($status_sh, 'selected') !== false) ? 'active' : '';
        $sheet_sh = (strpos($sheet_sh, 'selected') !== false) ? 'active' : '';
        $territory_sh = (strpos($territory_sh, 'selected') !== false) ? 'active' : '';
        $newlimit_sh = (strpos($newlimit_sh, 'selected') !== false) ? 'active' : '';
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=0A" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("Show Users"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1" class="nav-subitem <?php echo $new_sh; ?>">
          <?php echo _QXZ("Add A New User"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=1A" class="nav-subitem <?php echo $copy_sh; ?>">
          <?php echo _QXZ("Copy User"); ?>
        </a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=550" class="nav-subitem <?php echo $search_sh; ?>">
          <?php echo _QXZ("Search For A User"); ?>
        </a>
        <a href="./user_stats.php?user=<?php echo $user ?>" class="nav-subitem <?php echo $stats_sh; ?>">
          <?php echo _QXZ("User Stats"); ?>
        </a>
        <a href="./user_status.php?user=<?php echo $user ?>" class="nav-subitem <?php echo $status_sh; ?>">
          <?php echo _QXZ("User Status"); ?>
        </a>
        <a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>" class="nav-subitem <?php echo $sheet_sh; ?>">
          <?php echo _QXZ("Time Sheet"); ?>
        </a>
        <?php
        if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
          { ?>
        <a href="./user_territories.php?agent=<?php echo $user ?>" class="nav-subitem <?php echo $territory_sh; ?>">
          <?php echo _QXZ("User Territories"); ?>
        </a>
        <?php
          }
        if ($SSuser_new_lead_limit > 0)
          { ?>
        <a href="./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall" class="nav-subitem <?php echo $newlimit_sh; ?>">
          <?php echo _QXZ("Overall New Lead Limits"); ?>
        </a>
        <?php }
          }
      ?>
      <!-- CAMPAIGNS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=10" class="nav-item <?php echo strpos($campaigns_hh, 'selected') !== false ? 'active' : ''; ?>">
      ...
      if (strlen($campaigns_hh) > 25) 
        ...
        $list_sh = (strpos($list_sh, 'selected') !== false) ? 'active' : '';
        $status_sh = (strpos($status_sh, 'selected') !== false) ? 'active' : '';
        $hotkey_sh = (strpos($hotkey_sh, 'selected') !== false) ? 'active' : '';
        $recycle_sh = (strpos($recycle_sh, 'selected') !== false) ? 'active' : '';
        $autoalt_sh = (strpos($autoalt_sh, 'selected') !== false) ? 'active' : '';
        $pause_sh = (strpos($pause_sh, 'selected') !== false) ? 'active' : '';
        $listmix_sh = (strpos($listmix_sh, 'selected') !== false) ? 'active' : '';
        $preset_sh = (strpos($preset_sh, 'selected') !== false) ? 'active' : '';
        $accid_sh = (strpos($accid_sh, 'selected') !== false) ? 'active' : '';

        if ($sh=='basic') {$sh='list';}
        if ($sh=='detail') {$sh='list';}
        if ($sh=='dialstat') {$sh='list';}

        if ($sh=='list') {$list_sh="active";}
        if ($sh=='status') {$status_sh="active";}
        if ($sh=='hotkey') {$hotkey_sh="active";}
        if ($sh=='recycle') {$recycle_sh="active";}
        if ($sh=='autoalt') {$autoalt_sh="active";}
        if ($sh=='pause') {$pause_sh="active";}
        if ($sh=='listmix') {$listmix_sh="active";}
        if ($sh=='preset') {$preset_sh="active";}
        if ($sh=='accid') {$accid_sh="active";}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=10" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("Campaigns Main"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=32" class="nav-subitem <?php echo $status_sh; ?>">
          <?php echo _QXZ("Statuses"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=33" class="nav-subitem <?php echo $hotkey_sh; ?>">
        ...
        if ($SSoutbound_autodial_active > 0)
          {
          ?>
          <a href="<?php echo $ADMIN ?>?ADD=35" class="nav-subitem <?php echo $recycle_sh; ?>">
            <?php echo _QXZ("Lead Recycle"); ?>
          </a>
          <a href="<?php echo $ADMIN ?>?ADD=36" class="nav-subitem <?php echo $autoalt_sh; ?>">
            <?php echo _QXZ("Auto-Alt Dial"); ?>
          </a>
          <a href="<?php echo $ADMIN ?>?ADD=39" class="nav-subitem <?php echo $listmix_sh; ?>">
            <?php echo _QXZ("List Mix"); ?>
          </a>
          <?php
          }
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=37" class="nav-subitem <?php echo $pause_sh; ?>">
          <?php echo _QXZ("Pause Codes"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=301" class="nav-subitem <?php echo $preset_sh; ?>">
        ...
        if ($SScampaign_cid_areacodes_enabled > 0)
          {
          ?>
          <a href="<?php echo $ADMIN ?>?ADD=302" class="nav-subitem <?php echo $accid_sh; ?>">
      ...
      if ($SSoutbound_autodial_active > 0)
        {
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=100" class="nav-item <?php echo strpos($lists_hh, 'selected') !== false ? 'active' : ''; ?>">
        ...
        if (strlen($lists_hh) > 25) 
          ...
          $new_sh = (strpos($new_sh, 'selected') !== false) ? 'active' : '';
          $search_sh = (strpos($search_sh, 'selected') !== false) ? 'active' : '';
          $lead_sh = (strpos($lead_sh, 'selected') !== false) ? 'active' : '';
          $load_sh = (strpos($load_sh, 'selected') !== false) ? 'active' : '';
          $dnc_sh = (strpos($dnc_sh, 'selected') !== false) ? 'active' : '';
          $custom_sh = (strpos($custom_sh, 'selected') !== false) ? 'active' : '';
          $cpcust_sh = (strpos($cpcust_sh, 'selected') !== false) ? 'active' : '';
          $droplist_sh = (strpos($droplist_sh, 'selected') !== false) ? 'active' : '';

          if ($LOGdelete_from_dnc > 0) {$DNClink = _QXZ("Add-Delete DNC Number");}
          else {$DNClink = _QXZ("Add DNC Number");}

          if ($sh=='list') {$list_sh="active";}
          if ($sh=='new') {$new_sh="active";}
          if ($sh=='search') {$search_sh="active";}
          if ($sh=='lead') {$lead_sh="active";}
          if ($sh=='load') {$load_sh="active";}
          if ($sh=='dnc') {$dnc_sh="active";}
          if ($sh=='custom') {$custom_sh="active";}
          if ($sh=='cpcust') {$cpcust_sh="active";}
          if ($sh=='droplist') {$droplist_sh="active";}
          ?>
          <a href="<?php echo $ADMIN ?>?ADD=100" class="nav-subitem <?php echo $list_sh; ?>">
            <?php echo _QXZ("Show Lists"); ?>
          </a>
          <?php if ($add_copy_disabled < 1) { ?>
          <a href="<?php echo $ADMIN ?>?ADD=111" class="nav-subitem <?php echo $new_sh; ?>">
            <?php echo _QXZ("Add A New List"); ?>
          </a>
          <?php } ?>
          <a href="admin_search_lead.php" class="nav-subitem <?php echo $search_sh; ?>">
            <?php echo _QXZ("Search For A Lead"); ?>
          </a>
          <a href="admin_modify_lead.php" class="nav-subitem <?php echo $lead_sh; ?>">
            <?php echo _QXZ("Add A New Lead"); ?>
          </a>
          <a href="<?php echo $ADMIN ?>?ADD=121" class="nav-subitem <?php echo $dnc_sh; ?>">
            <?php echo $DNClink; ?>
          </a>
          <a href="./admin_listloader_fourth_gen.php" class="nav-subitem <?php echo $load_sh; ?>">
          ...
          if ($SScustom_fields_enabled > 0)
            ...
            ?>
            <a href="./<?php echo $admin_lists_custom ?>" class="nav-subitem <?php echo $custom_sh; ?>">
              <?php echo _QXZ("List Custom Fields"); ?>
            </a>
            <a href="./<?php echo $admin_lists_custom ?>?action=COPY_FIELDS_FORM" class="nav-subitem <?php echo $cpcust_sh; ?>">
          ...
          if ($SSenable_drop_lists > 0)
            {
            ?>
            <a href="<?php echo $ADMIN ?>?ADD=130" class="nav-subitem <?php echo $droplist_sh; ?>">
      ...
      if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
        { ?>
      <!-- QC navigation -->
      <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-item <?php echo strpos($qc_hh, 'selected') !== false ? 'active' : ''; ?>">
        <?php echo $qc_icon; ?> <?php echo _QXZ("Quality Control"); ?>
      </a>
      <?php
      if (strlen($qc_hh) > 25) 
        {
        $campaign_sh = (strpos($campaign_sh, 'selected') !== false) ? 'active' : '';
        $ingroup_sh = (strpos($ingroup_sh, 'selected') !== false) ? 'active' : '';
        $list_sh = (strpos($list_sh, 'selected') !== false) ? 'active' : '';
        $enter_sh = (strpos($enter_sh, 'selected') !== false) ? 'active' : '';
        $modify_sh = (strpos($modify_sh, 'selected') !== false) ? 'active' : '';
        $scorecard_sh = (strpos($scorecard_sh, 'selected') !== false) ? 'active' : '';
        ...
        if ($sh=='campaign') {$campaign_sh="active";}
        if ($sh=='ingroup') {$ingroup_sh="active";}
        if ($sh=='list') {$list_sh="active";}
        if ($sh=='enter') {$enter_sh="active";}
        if ($sh=='modify') {$modify_sh="active";}
        if ($sh=='scorecard') {$scorecard_sh="active";}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=CAMPAIGN" class="nav-subitem <?php echo $campaign_sh; ?>">
          <?php echo _QXZ("QC Calls by Campaign"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=LIST" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("QC Calls by List"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=INGROUP" class="nav-subitem <?php echo $ingroup_sh; ?>">
          <?php echo _QXZ("QC Calls by Ingroup"); ?>
        </a>
        <a href="qc_scorecards.php" class="nav-subitem <?php echo $scorecard_sh; ?>">
          <?php echo _QXZ("Show QC Scorecards"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=341111111111111" class="nav-subitem <?php echo $modify_sh; ?>">
      ...
      ?>
      <!-- SCRIPTS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=1000000" class="nav-item <?php echo strpos($scripts_hh, 'selected') !== false ? 'active' : ''; ?>">
      ...
      if (strlen($scripts_hh) > 25) 
        ...
        if ($sh=='new') {$new_sh="active";}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=1000000" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("Show Scripts"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1111111" class="nav-subitem <?php echo $new_sh; ?>">
      ...
      if ($SSoutbound_autodial_active > 0)
        {
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=10000000" class="nav-item <?php echo strpos($filters_hh, 'selected') !== false ? 'active' : ''; ?>">
        ...
        if (strlen($filters_hh) > 25) 
          ...
          if ($sh=='new') {$new_sh="active";}
          ?>
        <a href="<?php echo $ADMIN ?>?ADD=10000000" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("Show Filters"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=11111111" class="nav-subitem <?php echo $new_sh; ?>">
      ...
      ?>
      <!-- INGROUPS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=1001" class="nav-item <?php echo strpos($ingroups_hh, 'selected') !== false ? 'active' : ''; ?>">
        <?php echo $inbound_icon; ?> <?php echo _QXZ("Inbound"); ?>
      </a>
      <?php
      if (strlen($ingroups_hh) > 25) 
        {
        $listIG_sh = (strpos($listIG_sh, 'selected') !== false) ? 'active' : '';
        $newIG_sh = (strpos($newIG_sh, 'selected') !== false) ? 'active' : '';
        $copyIG_sh = (strpos($copyIG_sh, 'selected') !== false) ? 'active' : '';
        $listEG_sh = (strpos($listEG_sh, 'selected') !== false) ? 'active' : '';
        $newEG_sh = (strpos($newEG_sh, 'selected') !== false) ? 'active' : '';
        $copyEG_sh = (strpos($copyEG_sh, 'selected') !== false) ? 'active' : '';
        $listCG_sh = (strpos($listCG_sh, 'selected') !== false) ? 'active' : '';
        $newCG_sh = (strpos($newCG_sh, 'selected') !== false) ? 'active' : '';
        $copyCG_sh = (strpos($copyCG_sh, 'selected') !== false) ? 'active' : '';
        $listDID_sh = (strpos($listDID_sh, 'selected') !== false) ? 'active' : '';
        $newDID_sh = (strpos($newDID_sh, 'selected') !== false) ? 'active' : '';
        $copyDID_sh = (strpos($copyDID_sh, 'selected') !== false) ? 'active' : '';
        $didRA_sh = (strpos($didRA_sh, 'selected') !== false) ? 'active' : '';
        $listCM_sh = (strpos($listCM_sh, 'selected') !== false) ? 'active' : '';
        $newCM_sh = (strpos($newCM_sh, 'selected') !== false) ? 'active' : '';
        $copyCM_sh = (strpos($copyCM_sh, 'selected') !== false) ? 'active' : '';
        $listFPG_sh = (strpos($listFPG_sh, 'selected') !== false) ? 'active' : '';
        $newFPG_sh = (strpos($newFPG_sh, 'selected') !== false) ? 'active' : '';
        $addFPG_sh = (strpos($addFPG_sh, 'selected') !== false) ? 'active' : '';

        if ($sh=='listIG') {$listIG_sh="active";}
        if ($sh=='newIG') {$newIG_sh="active";}
        if ($sh=='copyIG') {$copyIG_sh="active";}
        if ($sh=='listEG') {$listEG_sh="active";}
        if ($sh=='newEG') {$newEG_sh="active";}
        if ($sh=='copyEG') {$copyEG_sh="active";}
        if ($sh=='listCG') {$listCG_sh="active";}
        if ($sh=='newCG') {$newCG_sh="active";}
        if ($sh=='copyCG') {$copyCG_sh="active";}
        if ($sh=='listDID') {$listDID_sh="active";}
        if ($sh=='newDID') {$newDID_sh="active";}
        if ($sh=='copyDID') {$copyDID_sh="active";}
        if ($sh=='didRA') {$didRA_sh="active";}
        if ($sh=='listCM') {$listCM_sh="active";}
        if ($sh=='newCM') {$newCM_sh="active";}
        if ($sh=='copyCM') {$copyCM_sh="active";}
        if ($sh=='listFPG') {$listFPG_sh="active";}
        if ($sh=='newFPG') {$newFPG_sh="active";}
        if ($sh=='addFPG') {$addFPG_sh="active";}

        if ($LOGdelete_from_dnc > 0) {$FPGlink = _QXZ("Add-Delete FPG Number");}
        else {$FPGlink = _QXZ("Add FPG Number");}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=1000" class="nav-subitem <?php echo $listIG_sh; ?>">
          <img src="images/icon_black_inbound.png" border=0 alt="In-Groups" width=14 height=14 valign=middle> <?php echo _QXZ("Show In-Groups"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1111" class="nav-subitem <?php echo $newIG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Add A New In-Group"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=1211" class="nav-subitem <?php echo $copyIG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Copy In-Group"); ?>
        </a>
        <?php } ?>
        ...
        if ($SSemail_enabled>0) 
          {
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=1800" class="nav-subitem <?php echo $listEG_sh; ?>">
          <img src="images/icon_email.png" border=0 alt="Email Groups" width=14 height=14 valign=middle> <?php echo _QXZ("Show Email Groups"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1811" class="nav-subitem <?php echo $newEG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Add New Email Group"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=1911" class="nav-subitem <?php echo $copyEG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Copy Email Group"); ?>
        </a>
        <?php } ?>
        <?php
          }
        ...
        if ($SSchat_enabled>0) 
          {
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=1900" class="nav-subitem <?php echo $listCG_sh; ?>">
          <img src="images/icon_chat.png" border=0 alt=" Chat Groups" width=14 height=14 valign=middle> <?php echo _QXZ("Show Chat Groups"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=18111" class="nav-subitem <?php echo $newCG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Add New Chat Group"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=19111" class="nav-subitem <?php echo $copyCG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Copy Chat Group"); ?>
        </a>
        <?php } ?>
        <?php
          }
        ...
        <a href="<?php echo $ADMIN ?>?ADD=1300" class="nav-subitem <?php echo $listDID_sh; ?>">
          <img src="images/icon_cidgroups.png" border=0 alt="DIDs" width=14 height=14 valign=middle> <?php echo _QXZ("Show DIDs"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1311" class="nav-subitem <?php echo $newDID_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Add A New DID"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=1411" class="nav-subitem <?php echo $copyDID_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Copy DID"); ?>
        </a>
        <?php
          }
        if ($SSdid_ra_extensions_enabled > 0)
          {
          ?>
        <a href="<?php echo $ADMIN ?>?ADD=1320" class="nav-subitem <?php echo $didRA_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("RA Extensions"); ?>
        </a>
          <?php
          }
        ?>
        
        <a href="<?php echo $ADMIN ?>?ADD=1500" class="nav-subitem <?php echo $listCM_sh; ?>">
          <img src="images/icon_callmenu.png" border=0 alt="Call Menus" width=14 height=14 valign=middle> <?php echo _QXZ("Show Call Menus"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1511" class="nav-subitem <?php echo $newCM_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Add A New Call Menu"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=1611" class="nav-subitem <?php echo $copyCM_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Copy Call Menu"); ?>
        </a>
        <?php } ?>

        <a href="<?php echo $ADMIN ?>?ADD=1700" class="nav-subitem <?php echo $listFPG_sh; ?>">
          <img src="images/icon_filterphonegroup.png" border=0 alt="Filter Phone Groups" width=14 height=14 valign=middle> <?php echo _QXZ("Filter Phone Groups"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1711" class="nav-subitem <?php echo $newFPG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo _QXZ("Add Filter Phone Group"); ?>
        </a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=171" class="nav-subitem <?php echo $addFPG_sh; ?>">
          <img src="images/blank.gif" border=0 alt=" " width=14 height=14 valign=middle> <?php echo $FPGlink; ?>
        </a>
        <?php } 
        ?>
      <!-- USERGROUPS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=100000" class="nav-item <?php echo strpos($usergroups_hh, 'selected') !== false ? 'active' : ''; ?>">
      ...
      if (strlen($usergroups_hh) > 25)
        ...
        $list_sh = (strpos($list_sh, 'selected') !== false) ? 'active' : '';
        $new_sh = (strpos($new_sh, 'selected') !== false) ? 'active' : '';
        $hour_sh = (strpos($hour_sh, 'selected') !== false) ? 'active' : '';
        $bulk_sh = (strpos($bulk_sh, 'selected') !== false) ? 'active' : '';

        if ($sh=='list') {$list_sh="active";}
        if ($sh=='new') {$new_sh="active";}
        if ($sh=='hour') {$hour_sh="active";}
        if ($sh=='bulk') {$bulk_sh="active";}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=100000" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("Show User Groups"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=111111" class="nav-subitem <?php echo $new_sh; ?>">
          <?php echo _QXZ("Add A New User Group"); ?>
        </a>
        <?php } ?>
        <a href="group_hourly_stats.php" class="nav-subitem <?php echo $hour_sh; ?>">
          <?php echo _QXZ("Group Hourly Report"); ?>
        </a>
        <a href="user_group_bulk_change.php" class="nav-subitem <?php echo $bulk_sh; ?>">
          <?php echo _QXZ("Bulk Group Change"); ?>
        </a>
        <?php } 
      ?>
      <!-- REMOTEAGENTS NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=10000" class="nav-item <?php echo strpos($remoteagent_hh, 'selected') !== false ? 'active' : ''; ?>">
      ...
      if (strlen($remoteagent_hh) > 25) 
        ...
        if ($sh=='newEG') {$newEG_sh="active";}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=10000" class="nav-subitem <?php echo $list_sh; ?>">
          <?php echo _QXZ("Show Remote Agents"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=11111" class="nav-subitem <?php echo $new_sh; ?>">
          <?php echo _QXZ("Add New Remote Agents"); ?>
        </a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=12000" class="nav-subitem <?php echo $listEG_sh; ?>">
          <?php echo _QXZ("Show Extension Groups"); ?>
        </a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=12111" class="nav-subitem <?php echo $newEG_sh; ?>">
      ...
      ?>
      <!-- ADMIN NAVIGATION -->
      <a href="<?php echo $ADMIN ?>?ADD=999998" class="nav-item <?php echo strpos($admin_hh, 'selected') !== false ? 'active' : ''; ?>">
        <?php echo $admin_icon; ?> <?php echo _QXZ("Admin"); ?>
      </a>
      <?php
      if (strlen($admin_hh) > 25) 
        {
        $times_sh = (strpos($times_sh, 'selected') !== false) ? 'active' : '';
        $shifts_sh = (strpos($shifts_sh, 'selected') !== false) ? 'active' : '';
        $templates_sh = (strpos($templates_sh, 'selected') !== false) ? 'active' : '';
        $carriers_sh = (strpos($carriers_sh, 'selected') !== false) ? 'active' : '';
        $phones_sh = (strpos($phones_sh, 'selected') !== false) ? 'active' : '';
        $server_sh = (strpos($server_sh, 'selected') !== false) ? 'active' : '';
        $conference_sh = (strpos($conference_sh, 'selected') !== false) ? 'active' : '';
        $settings_sh = (strpos($settings_sh, 'selected') !== false) ? 'active' : '';
        $label_sh = (strpos($label_sh, 'selected') !== false) ? 'active' : '';
        $colors_sh = (strpos($colors_sh, 'selected') !== false) ? 'active' : '';
        $status_sh = (strpos($status_sh, 'selected') !== false) ? 'active' : '';
        $audio_sh = (strpos($audio_sh, 'selected') !== false) ? 'active' : '';
        $moh_sh = (strpos($moh_sh, 'selected') !== false) ? 'active' : '';
        $languages_sh = (strpos($languages_sh, 'selected') !== false) ? 'active' : '';
        $soundboard_sh = (strpos($soundboard_sh, 'selected') !== false) ? 'active' : '';
        $vm_sh = (strpos($vm_sh, 'selected') !== false) ? 'active' : '';
        $tts_sh = (strpos($tts_sh, 'selected') !== false) ? 'active' : '';
        $cc_sh = (strpos($cc_sh, 'selected') !== false) ? 'active' : '';
        $cts_sh = (strpos($cts_sh, 'selected') !== false) ? 'active' : '';
        $sc_sh = (strpos($sc_sh, 'selected') !== false) ? 'active' : '';
        $sg_sh = (strpos($sg_sh, 'selected') !== false) ? 'active' : '';
        $cg_sh = (strpos($cg_sh, 'selected') !== false) ? 'active' : '';
        $vmmg_sh = (strpos($vmmg_sh, 'selected') !== false) ? 'active' : '';
        $qg_sh = (strpos($qg_sh, 'selected') !== false) ? 'active' : '';
        $emails_sh = (strpos($emails_sh, 'selected') !== false) ? 'active' : '';
        $ar_sh = (strpos($ar_sh, 'selected') !== false) ? 'active' : '';
        $il_sh = (strpos($il_sh, 'selected') !== false) ? 'active' : '';

        if ($sh=='times') {$times_sh="active";}
        if ($sh=='shifts') {$shifts_sh="active";}
        if ($sh=='templates') {$templates_sh="active";}
        if ($sh=='carriers') {$carriers_sh="active";}
        if ($sh=='phones') {$phones_sh="active";}
        if ($sh=='server') {$server_sh="active";}
        if ($sh=='conference') {$conference_sh="active";}
        if ($sh=='settings') {$settings_sh="active";}
        if ($sh=='label') {$label_sh="active";}
        if ($sh=='colors') {$colors_sh="active";}
        if ($sh=='status') {$status_sh="active";}
        if ($sh=='audio') {$audio_sh="active";}
        if ($sh=='moh') {$moh_sh="active";}
        if ($sh=='languages') {$languages_sh="active";}
        if ($sh=='soundboard') {$soundboard_sh="active";}
        if ($sh=='vm') {$vm_sh="active";}
        if ($sh=='tts') {$tts_sh="active";}
        if ($sh=='cc') {$cc_sh="active";}
        if ($sh=='cts') {$cts_sh="active";}
        if ($sh=='sc') {$sc_sh="active";}
        if ($sh=='sg') {$sg_sh="active";}
        if ($sh=='cg') {$cg_sh="active";}
        if ($sh=='vmmg') {$vmmg_sh="active";}
        if ($sh=='qg') {$qg_sh="active";}
        if ($sh=='emails') {$emails_sh="active";}
        if ($sh=='ar') {$ar_sh="active";}
        if ($sh=='il') {$il_sh="active";}
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=100000000" class="nav-subitem <?php echo $times_sh; ?>">
          <img src="images/icon_calltimes.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Call Times"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=130000000" class="nav-subitem <?php echo $shifts_sh; ?>">
          <img src="images/icon_shifts.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Shifts"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=10000000000" class="nav-subitem <?php echo $phones_sh; ?>">
          <img src="images/icon_phones.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Phones"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=130000000000" class="nav-subitem <?php echo $templates_sh; ?>">
          <img src="images/icon_templates.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Templates"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=140000000000" class="nav-subitem <?php echo $carriers_sh; ?>">
          <img src="images/icon_carriers.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Carriers"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=100000000000" class="nav-subitem <?php echo $server_sh; ?>">
          <img src="images/icon_servers.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Servers"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=1000000000000" class="nav-subitem <?php echo $conference_sh; ?>">
          <img src="images/icon_conferences.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Conferences"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=311111111111111" class="nav-subitem <?php echo $settings_sh; ?>">
          <img src="images/icon_settings.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("System Settings"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=180000000000" class="nav-subitem <?php echo $label_sh; ?>">
          <img src="images/icon_screenlabels.png" border=0 alt="Labels" width=14 height=14 valign=middle> <?php echo _QXZ("Screen Labels"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=182000000000" class="nav-subitem <?php echo $colors_sh; ?>">
          <img src="images/icon_screencolors.png" border=0 alt="Colors" width=14 height=14 valign=middle> <?php echo _QXZ("Screen Colors"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=321111111111111" class="nav-subitem <?php echo $status_sh; ?>">
          <img src="images/icon_statuses.png" border=0 alt="Statuses" width=14 height=14 valign=middle> <?php echo _QXZ("System Statuses"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=193000000000" class="nav-subitem <?php echo $sg_sh; ?>">
          <img src="images/icon_statusgroups.png" border=0 alt="Status Groups" width=14 height=14 valign=middle> <?php echo _QXZ("Status Groups"); ?>
        </a>
        <?php
        if ($SScampaign_cid_areacodes_enabled > 0)
          {
          ?>
        <a href="<?php echo $ADMIN ?>?ADD=196000000000" class="nav-subitem <?php echo $cg_sh; ?>">
          <img src="images/icon_cidgroups.png" border=0 alt="CID Groups" width=14 height=14 valign=middle> <?php echo _QXZ("CID Groups"); ?>
        </a>
        <?php
          }
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=170000000000" class="nav-subitem <?php echo $vm_sh; ?>">
          <img src="images/icon_voicemail.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Voicemail"); ?>
        </a>
        <?php
        if ($SSemail_enabled > 0)
          { ?>
        <a href="admin_email_accounts.php" class="nav-subitem <?php echo $emails_sh; ?>">
          <img src="images/icon_email.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Email Accounts"); ?>
        </a>
        <?php }
        if ( ($sounds_central_control_active > 0) or ($SSsounds_central_control_active > 0) )
          { ?>
        <a href="audio_store.php" class="nav-subitem <?php echo $audio_sh; ?>">
          <img src="images/icon_audiostore.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Audio Store"); ?>
        </a>
        <a href="<?php echo $ADMIN ?>?ADD=160000000000" class="nav-subitem <?php echo $moh_sh; ?>">
          <img src="images/icon_musiconhold.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Music On Hold"); ?>
        </a>
        <?php
        if ($SSenable_languages > 0)
                { ?>
        <a href="admin_languages.php?ADD=163000000000" class="nav-subitem <?php echo $languages_sh; ?>">
          <img src="images/icon_languages.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Languages"); ?>
        </a>
        <?php }
        if ( (preg_match("/soundboard/",$SSactive_modules) ) or ($SSagent_soundboards > 0) )
                {
        ?>
        <a href="admin_soundboard.php?ADD=162000000000" class="nav-subitem <?php echo $soundboard_sh; ?>">
          <img src="images/icon_audiosoundboards.png" border=0 alt="Audio Soundboards" width=14 height=14 valign=middle> <?php echo _QXZ("Audio Soundboards"); ?>
        </a>
        <?php 
                }

            ?>
        <a href="<?php echo $ADMIN ?>?ADD=197000000000" class="nav-subitem <?php echo $vmmg_sh; ?>">
          <img src="images/icon_vm_messages.png" border=0 alt="VM Message Groups" width=14 height=14 valign=middle> <?php echo _QXZ("VM Message Groups"); ?>
        </a>
        ...
        if ($SSenable_tts_integration > 0)
          { ?>
        <a href="<?php echo $ADMIN ?>?ADD=150000000000" class="nav-subitem <?php echo $tts_sh; ?>">
          <img src="images/icon_texttospeech.png" border=0 alt="Text To Speech" width=14 height=14 valign=middle> <?php echo _QXZ("Text To Speech"); ?>
        </a>

        <?php }
        if ($SScallcard_enabled > 0)
          { ?>
        <a href="callcard_admin.php" class="nav-subitem <?php echo $cc_sh; ?>">
          <img src="images/icon_callcard.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("CallCard Admin"); ?>
        </a>

        <?php }
        if ($SScontacts_enabled > 0)
          { ?>
        <a href="<?php echo $ADMIN ?>?ADD=190000000000" class="nav-subitem <?php echo $cts_sh; ?>">
          <img src="images/icon_contacts.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Contacts"); ?>
        </a>

        <?php }
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=192000000000" class="nav-subitem <?php echo $sc_sh; ?>">
          <img src="images/icon_settingscontainer.png" border=0 alt="Users" width=14 height=14 valign=middle> <?php echo _QXZ("Settings Containers"); ?>
        </a>
        <?php
        if ($SSenable_auto_reports > 0)
          { ?>
        <a href="<?php echo $ADMIN ?>?ADD=194000000000" class="nav-subitem <?php echo $ar_sh; ?>">
          <img src="images/icon_autoreports.png" border=0 alt="Automated Reports" width=14 height=14 valign=middle> <?php echo _QXZ("Automated Reports"); ?>
        </a>

        <?php }
        if ($SSallow_ip_lists > 0)
          { ?>
        <a href="<?php echo $ADMIN ?>?ADD=195000000000" class="nav-subitem <?php echo $il_sh; ?>">
          <img src="images/icon_iplists.png" border=0 alt="IP Lists" width=14 height=14 valign=middle> <?php echo _QXZ("IP Lists"); ?>
        </a>

        <?php }
        ?>
        <a href="<?php echo $ADMIN ?>?ADD=198000000000" class="nav-subitem <?php echo $qg_sh; ?>">
          <img src="images/icon_queuegroups.png" border=0 alt="Queue Groups" width=14 height=14 valign=middle> <?php echo _QXZ("Queue Groups"); ?>
        </a>
        <?php
            }
          }
        ...
        if ($reports_only_user > 0)
          ...
          <!-- QC NAVIGATION -->
          <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-item <?php echo strpos($qc_hh, 'selected') !== false ? 'active' : ''; ?>">
            <?php echo $reports_icon; ?> <?php echo _QXZ("Quality Control"); ?>
          </a>
          <?php
          if (strlen($qc_hh) > 25) 
                {
              ?>
          <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-subitem <?php echo $qc_color; ?>">
            <?php echo _QXZ("Show QC Campaigns"); ?>
          </a>
          <a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="nav-subitem <?php echo $qc_color; ?>">
            <?php echo _QXZ("Enter QC Queue"); ?>
          </a>
          <a href="<?php echo $ADMIN ?>?ADD=341111111111111" class="nav-subitem <?php echo $qc_color; ?>">
            <?php echo _QXZ("Modify QC Codes"); ?>
          </a>
                <?php }
                }
  ...
  <div class="main-content">
    <div class="content-header">
      <div class="content-title">
        <a href="<?php echo $admin_home_url_LU ?>" style="text-decoration: none; color: inherit;"><?php echo _QXZ("HOME"); ?></a> | 
        <A HREF="../agc/timeclock.php?referrer=admin" style="text-decoration: none; color: inherit;"><?php echo _QXZ("Timeclock"); ?></A> | 
        <a href="manager_chat_interface.php" style="text-decoration: none; color: inherit;"><?php echo _QXZ("Chat"); ?></a> | 
        <a href="<?php echo $ADMIN ?>?force_logout=1" style="text-decoration: none; color: inherit;"><?php echo _QXZ("Logout"); ?></a> 
        (<?php echo $PHP_AUTH_USER ?>)
        <?php
        if ($SSenable_languages == '1')
          {
          echo " | <a href=\"$ADMIN?ADD=999989\" style=\"text-decoration: none; color: inherit;\">"._QXZ("Change language")."</a>";
          }
        ?>
      </div>
    ...
    <div class="content-card">
      ...
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=10" class="btn btn-secondary"><?php echo _QXZ("Show Campaigns"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=11" class="btn btn-secondary"><?php echo _QXZ("Add A New Campaign"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=12" class="btn btn-secondary"><?php echo _QXZ("Copy Campaign"); ?></a>
        <?php } ?>
        <a href="./AST_timeonVDADallSUMMARY.php" class="btn btn-secondary"><?php echo _QXZ("Real-Time Campaigns Summary"); ?></a>
      </div>
        <?php }
      if ( (strlen($droplist_sh) > 25) and ($SSenable_drop_lists > 0) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=130" class="btn btn-secondary"><?php echo _QXZ("Show Drop Lists"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=131" class="btn btn-secondary"><?php echo _QXZ("Add A New Drop List"); ?></a>
        <?php } ?>
      </div>
        <?php }
      if (strlen($times_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=100000000" class="btn btn-secondary"><?php echo _QXZ("Show Call Times"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Call Time"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=1000000000" class="btn btn-secondary"><?php echo _QXZ("Show State Call Times"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New State Call Time"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=1200000000" class="btn btn-secondary"><?php echo _QXZ("Holidays"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1211111111" class="btn btn-secondary"><?php echo _QXZ("Add Holiday"); ?></a>
        <?php } ?>
      </div>
        <?php } 
      if (strlen($shifts_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=130000000" class="btn btn-secondary"><?php echo _QXZ("Show Shifts"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=131111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Shift"); ?></a>
        <?php } ?>
      </div>
        <?php } 
      if (strlen($phones_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=10000000000" class="btn btn-secondary"><?php echo _QXZ("Show Phones"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=11111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Phone"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=12222222222" class="btn btn-secondary"><?php echo _QXZ("Copy an Existing Phone"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=12000000000" class="btn btn-secondary"><?php echo _QXZ("Phone Alias List"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=12111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Phone Alias"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=13000000000" class="btn btn-secondary"><?php echo _QXZ("Group Alias List"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=13111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Group Alias"); ?></a>
        <?php } ?>
      </div>
        <?php }
      if (strlen($conference_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=1000000000000" class="btn btn-secondary"><?php echo _QXZ("Show Conferences"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=1111111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Conference"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=10000000000000" class="btn btn-secondary"><?php echo _QXZ("Show VICIDIAL Conferences"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=11111111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New VICIDIAL Conference"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=12000000000000" class="btn btn-secondary"><?php echo _QXZ("Show ConfBridges"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=12111111111111" class="btn btn-secondary"><?php echo _QXZ("Add ConfBridge"); ?></a>
        <?php } ?>
      </div>
        <?php }
      if ( (strlen($server_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=100000000000" class="btn btn-secondary"><?php echo _QXZ("Show Servers"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=111111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Server"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (strlen($templates_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=130000000000" class="btn btn-secondary"><?php echo _QXZ("Show Templates"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=131111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Template"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (strlen($carriers_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=140000000000" class="btn btn-secondary"><?php echo _QXZ("Show Carriers"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=141111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Carrier"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=140111111111" class="btn btn-secondary"><?php echo _QXZ("Copy A Carrier"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (strlen($emails_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="admin_email_accounts.php" class="btn btn-secondary"><?php echo _QXZ("Show Email Accounts"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="admin_email_accounts.php?eact=ADD" class="btn btn-secondary"><?php echo _QXZ("Add A New Account"); ?></a>
        <a href="admin_email_accounts.php?eact=COPY" class="btn btn-secondary"><?php echo _QXZ("Copy An Account"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (strlen($tts_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=150000000000" class="btn btn-secondary"><?php echo _QXZ("Show TTS Entries"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=151111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New TTS Entry"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (strlen($cc_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="callcard_admin.php" class="btn btn-secondary"><?php echo _QXZ("CallCard Summary"); ?></a>
        <a href="callcard_admin.php?action=CALLCARD_RUNS" class="btn btn-secondary"><?php echo _QXZ("Runs"); ?></a>
        <a href="callcard_admin.php?action=CALLCARD_BATCHES" class="btn btn-secondary"><?php echo _QXZ("Batches"); ?></a>
        <a href="callcard_admin.php?action=SEARCH" class="btn btn-secondary"><?php echo _QXZ("CallCard Search"); ?></a>
        <a href="callcard_report_export.php" class="btn btn-secondary"><?php echo _QXZ("CallCard Log Export"); ?></a>
        <a href="callcard_admin.php?action=GENERATE" class="btn btn-secondary"><?php echo _QXZ("CallCard Generate New Numbers"); ?></a>
      </div>
      <?php }
      if ( (strlen($moh_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=160000000000" class="btn btn-secondary"><?php echo _QXZ("Show MOH Entries"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=161111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New MOH Entry"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (strlen($languages_sh) > 25) and (strlen($admin_hh) > 25) and ($SSenable_languages > 0) ) { 
        ?>
      <div class="sub-navigation">
        <a href="admin_languages.php?ADD=163000000000" class="btn btn-secondary"><?php echo _QXZ("Show Languages"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="admin_languages.php?ADD=163111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Language"); ?></a>
        <a href="admin_languages.php?ADD=163211111111" class="btn btn-secondary"><?php echo _QXZ("Copy A Languages Entry"); ?></a>
        <a href="admin_languages.php?ADD=163311111111" class="btn btn-secondary"><?php echo _QXZ("Import Phrases"); ?></a>
        <a href="admin_languages.php?ADD=163411111111" class="btn btn-secondary"><?php echo _QXZ("Export Phrases"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if ( (preg_match("/soundboard/",$SSactive_modules) ) or ($SSagent_soundboards > 0) )
        ...
        ?>
      <div class="sub-navigation">
        <a href="admin_soundboard.php?ADD=162000000000" class="btn btn-secondary"><?php echo _QXZ("Show Soundboard Entries"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="admin_soundboard.php?ADD=162111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Soundboard Entry"); ?></a>
        <a href="admin_soundboard.php?ADD=162211111111" class="btn btn-secondary"><?php echo _QXZ("Copy A Soundboard Entry"); ?></a>
        <?php } ?>
      </div>
      <?php
          }
      ...
      if ( (strlen($vm_sh) > 25) and (strlen($admin_hh) > 25) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=170000000000" class="btn btn-secondary"><?php echo _QXZ("Show Voicemail Entries"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=171111111111" class="btn btn-secondary"><?php echo _QXZ("Add A New Voicemail Entry"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($settings_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=311111111111111" class="btn btn-secondary"><?php echo _QXZ("System Settings"); ?></a>
      </div>
      <?php }
      if (strlen($label_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=180000000000" class="btn btn-secondary"><?php echo _QXZ("Screen Labels"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=181111111111" class="btn btn-secondary"><?php echo _QXZ("Add A Screen Label"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($colors_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=182000000000" class="btn btn-secondary"><?php echo _QXZ("Screen Colors"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=182111111111" class="btn btn-secondary"><?php echo _QXZ("Add A Screen Colors"); ?></a>
        <?php } ?>
        <a href="<?php echo $ADMIN ?>?ADD=311111111111111#screen_colors" class="btn btn-secondary"><?php echo _QXZ("Change Active Screen Colors"); ?></a>
      </div>
      <?php }
      if (strlen($cts_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=190000000000" class="btn btn-secondary"><?php echo _QXZ("Contacts"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=191111111111" class="btn btn-secondary"><?php echo _QXZ("Add A Contact"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($sc_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=192000000000" class="btn btn-secondary"><?php echo _QXZ("Settings Containers"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=192111111111" class="btn btn-secondary"><?php echo _QXZ("Add A Settings Container"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($ar_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=194000000000" class="btn btn-secondary"><?php echo _QXZ("Automated Reports"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=194111111111" class="btn btn-secondary"><?php echo _QXZ("Add An Automated Report"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($il_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=195000000000" class="btn btn-secondary"><?php echo _QXZ("IP Lists"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=195111111111" class="btn btn-secondary"><?php echo _QXZ("Add An IP List"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($sg_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=193000000000" class="btn btn-secondary"><?php echo _QXZ("Status Groups"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=193111111111" class="btn btn-secondary"><?php echo _QXZ("Add A Status Group"); ?></a>
        <?php } ?>
      </div>
      <?php }
      if (strlen($cg_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=196000000000" class="btn btn-secondary"><?php echo _QXZ("CID Groups"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=196111111111" class="btn btn-secondary"><?php echo _QXZ("Add A CID Group"); ?></a>
        <?php } ?>
      </div>
      <?php }
if (strlen($vmmg_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=197000000000" class="btn btn-secondary"><?php echo _QXZ("VM Message Groups"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=197111111111" class="btn btn-secondary"><?php echo _QXZ("Add A VM Message Group"); ?></a>
        <?php } ?>
      </div>
      <?php }
if (strlen($qg_sh) > 25) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=198000000000" class="btn btn-secondary"><?php echo _QXZ("Queue Groups"); ?></a>
        <?php if ($add_copy_disabled < 1) { ?>
        <a href="<?php echo $ADMIN ?>?ADD=198111111111" class="btn btn-secondary"><?php echo _QXZ("Add A Queue Group"); ?></a>
        <?php } ?>
      </div>
      <?php }
if ( (strlen($status_sh) > 25) and (!preg_match('/campaign|user/i',$hh) ) ) { 
        ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=321111111111111" class="btn btn-secondary"><?php echo _QXZ("System Statuses"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=331111111111111" class="btn btn-secondary"><?php echo _QXZ("Status Categories"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=341111111111111" class="btn btn-secondary"><?php echo _QXZ("QC Status Codes"); ?></a>
      </div>
      <?php }
...
if ( ($ADD=='3') or ($ADD=='3') ) { 
        ?>
      <div class="sub-navigation">
        <a href="./user_stats.php?user=<?php echo $user ?>" class="btn btn-secondary"><?php echo _QXZ("User Stats"); ?></a>
        <a href="./user_status.php?user=<?php echo $user ?>" class="btn btn-secondary"><?php echo _QXZ("User Status"); ?></a>
        <a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>" class="btn btn-secondary"><?php echo _QXZ("Time Sheet"); ?></a>
        <a href="./AST_agent_days_detail.php?user=<?php echo $user ?>" class="btn btn-secondary"><?php echo _QXZ("Days Status"); ?></a>
      </div>
      <?php }
...
if ( ($ADD=='999988') or ($ADD=='999987') or ($ADD=='999986') or ($ADD=='999985') ) 
    ...
    ?>
      <div class="sub-navigation">
        <a href="<?php echo $ADMIN ?>?ADD=999988" class="btn btn-secondary"><?php echo _QXZ("Available Timezones"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=999987" class="btn btn-secondary"><?php echo _QXZ("Phone Codes"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=999986" class="btn btn-secondary"><?php echo _QXZ("Postal Codes"); ?></a>
        <a href="<?php echo $ADMIN ?>?ADD=999985" class="btn btn-secondary"><?php echo _QXZ("Postal Codes Cities"); ?></a>
      </div>
    <?php 
    }
else
