...
{
?>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=999999" ALT="Reports" class="nav-link"><?php echo $reports_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Reports"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=0A" ALT="Users" class="nav-link"><?php echo $users_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Users"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=10" ALT="Campaigns" class="nav-link"><?php echo $campaigns_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Campaigns"); ?></B></FONT></A> &nbsp; </TD>
<?php
if (($SSqc_features_active=='1') && ($qc_auth=='1')) 
{
?>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=100000000000000" ALT="Quality Control" class="nav-link"><?php echo $qc_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Quality Control"); ?></B></FONT></A> &nbsp; </TD>
<?php
}
?>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=100" ALT="Lists" class="nav-link"><?php echo $lists_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Lists"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=1000000" ALT="Scripts" class="nav-link"><?php echo $scripts_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Scripts"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=10000000" ALT="Filters" class="nav-link"><?php echo $filters_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Filters"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=1001" ALT="Inbound" class="nav-link"><?php echo $inbound_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Inbound"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=100000" ALT="User Groups" class="nav-link"><?php echo $usergroups_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("User Groups"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=10000" ALT="Remote Agents" class="nav-link"><?php echo $remoteagents_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Remote Agents"); ?></B></FONT></A> &nbsp; </TD>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=999998" ALT="Admin" class="nav-link"><?php echo $admin_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Admin"); ?></B></FONT></A> &nbsp; </TD>
<?php 
}
else 
{ 
...
{
?>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=999999" ALT="Reports" class="nav-link"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Reports"); ?></B></A> &nbsp; </TD>
<?php
}
else
{
...
{
?>
<TD> &nbsp; <A HREF="<?php echo $ADMIN ?>?ADD=100000000000000" ALT="Quality Control" class="nav-link"><FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Quality Control"); ?></B></FONT></A> &nbsp; </TD>
<?php
}
}
}
...
<TD align='left'> &nbsp; <A HREF="admin_mobile.php?ADD=999990" ALT="Admin" class="nav-link"><?php echo $admin_icon ?> <FONT FACE="ARIAL,HELVETICA" COLOR=WHITE SIZE=2><B><?php echo _QXZ("Admin"); ?></B></FONT></A> &nbsp; </TD>
</TR>
</TABLE>
</div>
</div>
...
/* Modern CSS with Purple Gradient Theme */
body {
...
<TR <?php echo $reports_hh ?>><TD ALIGN=LEFT WIDTH=160>
<a href="<?php echo $ADMIN ?>?ADD=999999" class="sidebar-menu-item"><?php echo $reports_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $reports_fc ?>"><?php echo $reports_bold ?> <?php echo _QXZ("Reports"); ?> </a>
</TD></TR>

<!-- USERS NAVIGATION -->
<TR WIDTH=100%><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR WIDTH=160 <?php echo $users_hh ?>><TD ALIGN=LEFT WIDTH=160>
<a href="<?php echo $ADMIN ?>?ADD=0A" class="sidebar-menu-item"><?php echo $users_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $users_fc ?>"><?php echo $users_bold ?><?php echo _QXZ("Users"); ?></a>
</TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=0A" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("Show Users"); ?> </a>
</TR><TR <?php echo $new_sh ?>><TD ALIGN=LEFT>
<?php if ($add_copy_disabled < 1) { ?>
 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("Add A New User"); ?> </a>
</TR><TR <?php echo $copy_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=1A" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("Copy User"); ?> </a>
</TR><TR <?php echo $search_sh ?>><TD ALIGN=LEFT>
<?php } ?>
 &nbsp; <a href="<?php echo $ADMIN ?>?ADD=550" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("Search For A User"); ?> </a>
</TR><TR <?php echo $stats_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="./user_stats.php?user=<?php echo $user ?>" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("User Stats"); ?> </a>
</TR><TR <?php echo $status_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="./user_status.php?user=<?php echo $user ?>" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("User Status"); ?> </a>
</TR><TR <?php echo $sheet_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("Time Sheet"); ?> </a> </TD></TR>
 <?php
if ( ($SSuser_territories_active > 0) or ($user_territories_active > 0) )
{ ?>

</TR><TR <?php echo $territory_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="./user_territories.php?agent=<?php echo $user ?>" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("User Territories"); ?> </a> </TD></TR>
...
</TR><TR <?php echo $newlimit_sh ?>><TD ALIGN=LEFT>
 &nbsp; <a href="./admin_user_list_new.php?user=---ALL---&list_id=NONE&stage=overall" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK"><?php echo _QXZ("Overall New Lead Limits"); ?> </a> </TD></TR>
...
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $campaigns_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=10" class="sidebar-menu-item"><?php echo $campaigns_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $campaigns_fc ?>"><?php echo $campaigns_bold ?><?php echo _QXZ("Campaigns"); ?></a>
</TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>>
<TD ALIGN=LEFT <?php echo $list_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=10" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("Campaigns Main"); ?></a></TD>
</TR><TR <?php echo $status_sh ?>>
<TD ALIGN=LEFT <?php echo $status_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=32" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("Statuses"); ?></a></TD>
</TR><TR <?php echo $hotkey_sh ?>>
<TD ALIGN=LEFT <?php echo $hotkey_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=33" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("HotKeys"); ?></a></TD>
<?php
if ($SSoutbound_autodial_active > 0)
{
?>
</TR><TR <?php echo $recycle_sh ?>>
<TD ALIGN=LEFT <?php echo $recycle_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=35" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("Lead Recycle"); ?></a></TD>
</TR><TR <?php echo $autoalt_sh ?>>
<TD ALIGN=LEFT <?php echo $autoalt_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=36" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("Auto-Alt Dial"); ?></a></TD>
</TR><TR <?php echo $listmix_sh ?>>
<TD ALIGN=LEFT <?php echo $listmix_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=39" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("List Mix"); ?></a></TD>
<?php
}
?>
</TR><TR <?php echo $pause_sh ?>>
<TD ALIGN=LEFT <?php echo $pause_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=37" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("Pause Codes"); ?></a></TD>
</TR><TR <?php echo $preset_sh ?>>
<TD ALIGN=LEFT <?php echo $preset_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=301" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("Presets"); ?></a></TD>
<?php
if ($SScampaign_cid_areacodes_enabled > 0)
{
?>
</TR><TR <?php echo $accid_sh ?>>
<TD ALIGN=LEFT <?php echo $accid_sh ?>> &nbsp; <a href="<?php echo $ADMIN ?>?ADD=302" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subheader_font_size ?>;color:BLACK;"><?php echo _QXZ("AC-CID"); ?></a></TD>
<?php
}
} 
?>
...
?>
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $lists_hh ?>><TD ALIGN=LEFT><a href="<?php echo $ADMIN ?>?ADD=100" class="sidebar-menu-item"><?php echo $lists_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $lists_fc ?>"><?php echo $lists_bold ?><?php echo _QXZ("Lists"); ?></a></TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=100" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Lists"); ?> </a>
</TR><TR <?php echo $new_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New List"); ?> </a>
</TR><TR <?php echo $search_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php } ?>
<a href="admin_search_lead.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Search For A Lead"); ?> </a>
</TR><TR <?php echo $lead_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="admin_modify_lead.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New Lead"); ?> </a>
</TR><TR <?php echo $dnc_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=121" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo $DNClink ?> </a>
</TR><TR <?php echo $load_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="./admin_listloader_fourth_gen.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Load New Leads"); ?> </a>
<?php
if ($SScustom_fields_enabled > 0)
{
 $admin_lists_custom = 'admin_lists_custom.php';
?>
</TR><TR <?php echo $custom_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="./<?php echo $admin_lists_custom ?>" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("List Custom Fields"); ?> </a>
</TR><TR <?php echo $cpcust_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="./<?php echo $admin_lists_custom ?>?action=COPY_FIELDS_FORM" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Copy Custom Fields"); ?> </a>
<?php
}
if ($SSenable_drop_lists > 0)
{
?>
<TR <?php echo $droplist_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=130" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Drop Lists"); ?> </a>
<?php
}
?>
</TD></TR>
...
<TR <?php echo $qc_hh ?>>
<TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="sidebar-menu-item"><?php echo $qc_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $qc_fc ?>"><?php echo $qc_bold ?> <?php echo _QXZ("Quality Control"); ?> </FONT></a>
</TD>
</TR>
<?php
if (strlen($qc_hh) > 25) 
...
<TD ALIGN=LEFT> &nbsp;
<a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=CAMPAIGN" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("QC Calls by Campaign"); ?> </FONT></a>
</TD>
</TR>
<TR <?php echo $list_sh ?>>
<TD ALIGN=LEFT> &nbsp;
<a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=LIST" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("QC Calls by List"); ?> </FONT></a>
</TD>
</TR>
<TR <?php echo $ingroup_sh ?>>
<TD ALIGN=LEFT> &nbsp;
<a href="<?php echo $ADMIN ?>?ADD=100000000000000&qc_display_group_type=INGROUP" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("QC Calls by Ingroup"); ?> </FONT></a>
</TD>
</TR>
<!--
<TR <?php echo $enter_sh ?>>
<TD ALIGN=LEFT> &nbsp;
<a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Enter QC Queue"); ?> </FONT></a>
</TD>
</TR>
//-->
<TR <?php echo $scorecard_sh ?>>
<TD ALIGN=LEFT> &nbsp;
<a href="qc_scorecards.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show QC Scorecards"); ?> </FONT></a>
</TD>
</TR>
<TR <?php echo $modify_sh ?>>
<TD ALIGN=LEFT> &nbsp;
<a href="<?php echo $ADMIN ?>?ADD=341111111111111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Modify QC Codes"); ?> </FONT></a>
</TD>
</TR>
<?php }
}
...
<!-- SCRIPTS NAVIGATION -->
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $scripts_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=1000000" class="sidebar-menu-item"><?php echo $scripts_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $scripts_fc ?>"><?php echo $scripts_bold ?> <?php echo _QXZ("Scripts"); ?> </a>
</TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Scripts"); ?> </a>
</TR><TR <?php echo $new_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=1111111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New Script"); ?> </a>
<?php } ?>
</TD></TR>
<?php } 
?>
...
?>
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $filters_hh ?>><TD ALIGN=LEFT><a href="<?php echo $ADMIN ?>?ADD=10000000" class="sidebar-menu-item"><?php echo $filters_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $filters_fc ?>"><?php echo $filters_bold ?> <?php echo _QXZ("Filters"); ?> </a></TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=10000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Filters"); ?> </a>
</TR><TR <?php echo $new_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=11111111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New Filter"); ?> </a>
<?php } ?>
</TD></TR>
<?php } 
}
...
<!-- INGROUPS NAVIGATION -->
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $ingroups_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=1001" class="sidebar-menu-item"><?php echo $inbound_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $ingroups_fc ?>"><?php echo $ingroups_bold ?> <?php echo _QXZ("Inbound"); ?> </a>
</TD></TR>
<?php
...
?>
<TR <?php echo $listIG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1000" class="sidebar-menu-item"><img src="images/icon_black_inbound.png" border=0 alt=\"In-Groups\" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show In-Groups"); ?> </a>
</TD></TR><TR <?php echo $newIG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=1111" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New In-Group"); ?> </a>
</TD></TR><TR <?php echo $copyIG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1211" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Copy In-Group"); ?> </a>
<?php } ?>
...
{
?>
<TR <?php echo $listEG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1800" class="sidebar-menu-item"><img src="images/icon_email.png" border=0 alt=\"Email Groups\" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Email Groups"); ?> </a>
</TD></TR><TR <?php echo $newEG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=1811" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add New Email Group"); ?> </a>
</TD></TR><TR <?php echo $copyEG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1911" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Copy Email Group"); ?> </a>
<?php } ?>
<TR WIDTH=160 CLASS="subhead_style"><TD><DIV CLASS="horiz_line_grey"></DIV></TD></TR>
<?php
}
...
{
?>
<TR <?php echo $listCG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1900" class="sidebar-menu-item"><img src="images/icon_chat.png" border=0 alt=\" Chat Groups\" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Chat Groups"); ?> </a>
</TD></TR><TR <?php echo $newCG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=18111" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add New Chat Group"); ?> </a>
</TD></TR><TR <?php echo $copyCG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=19111" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Copy Chat Group"); ?> </a>
<?php } ?>
<TR WIDTH=160 CLASS="subhead_style"><TD><DIV CLASS="horiz_line_grey"></DIV></TD></TR>
<?php
}
?>
</TD></TR><TR <?php echo $listDID_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1300" class="sidebar-menu-item"><img src="images/icon_cidgroups.png" border=0 alt=\"DIDs\" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show DIDs"); ?> </a>
</TD></TR><TR <?php echo $newDID_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=1311" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New DID"); ?> </a>
</TD></TR><TR <?php echo $copyDID_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1411" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Copy DID"); ?> </a>
<?php
}
if ($SSdid_ra_extensions_enabled > 0)
{
?>
</TD></TR><TR <?php echo $didRA_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1320" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"><?php echo _QXZ("RA Extensions"); ?></a>
<?php
}
?>
<TR WIDTH=160 CLASS="subhead_style"><TD><DIV CLASS="horiz_line_grey"></DIV></TD></TR>
</TD></TR><TR <?php echo $listCM_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1500" class="sidebar-menu-item"><img src="images/icon_callmenu.png" border=0 alt=\"Call Menus\" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Call Menus"); ?> </a>
</TD></TR><TR <?php echo $newCM_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=1511" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New Call Menu"); ?> </a>
</TD></TR><TR <?php echo $copyCM_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1611" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Copy Call Menu"); ?> </a>
<?php } ?>

<TR WIDTH=160 CLASS="subhead_style"><TD><DIV CLASS="horiz_line_grey"></DIV></TD></TR>
</TD></TR><TR <?php echo $listFPG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1700" class="sidebar-menu-item"><img src="images/icon_filterphonegroup.png" border=0 alt=\"Filter Phone Groups\" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Filter Phone Groups"); ?> </a>
</TD></TR><TR <?php echo $newFPG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=1711" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add Filter Phone Group"); ?> </a>
</TD></TR><TR <?php echo $addFPG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php } ?>
<a href="<?php echo $ADMIN ?>?ADD=171" class="sidebar-menu-item"><img src="images/blank.gif" border=0 alt=\" \" width=14 height=14 valign=middle> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo $FPGlink ?> </a>
</TD></TR>
<?php } 
?>
<!-- USERGROUPS NAVIGATION -->
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $usergroups_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=100000" class="sidebar-menu-item"><?php echo $usergroups_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $usergroups_fc ?>"><?php echo $usergroups_bold ?> <?php echo _QXZ("User Groups"); ?> </a>
</TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=100000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show User Groups"); ?> </a>
</TR><TR <?php echo $new_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=111111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add A New User Group"); ?> </a>
</TR><TR <?php echo $hour_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php } ?>
<a href="group_hourly_stats.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Group Hourly Report"); ?> </a>
</TR><TR <?php echo $bulk_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="user_group_bulk_change.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Bulk Group Change"); ?> </a>
</TD></TR>
<?php } 
?>
<!-- REMOTEAGENTS NAVIGATION -->
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $remoteagent_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=10000" class="sidebar-menu-item"><?php echo $remoteagents_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $remoteagent_fc ?>"><?php echo $remoteagent_bold ?> <?php echo _QXZ("Remote Agents"); ?> </a>
</TD></TR>
<?php
...
?>
<TR <?php echo $list_sh ?>><TD ALIGN=LEFT> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=10000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Remote Agents"); ?> </a>
</TR><TR <?php echo $new_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=11111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add New Remote Agents"); ?> </a>
</TR><TR <?php echo $listEG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php } ?>
<a href="<?php echo $ADMIN ?>?ADD=12000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show Extension Groups"); ?> </a>
</TR><TR <?php echo $newEG_sh ?>><TD ALIGN=LEFT> &nbsp; 
<?php if ($add_copy_disabled < 1) { ?>
<a href="<?php echo $ADMIN ?>?ADD=12111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Add Extension Group"); ?> </a>
<?php } ?>
</TD></TR>
<?php } 
?>
<!-- ADMIN NAVIGATION -->
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $admin_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=999998" class="sidebar-menu-item"><?php echo $admin_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $admin_fc ?>"><?php echo $admin_bold ?> <?php echo _QXZ("Admin"); ?> </a>
</TD></TR>
<?php
...
<a href="<?php echo $ADMIN ?>?ADD=100000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_calltimes.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Call Times"); ?> </a></TD>
</TR><TR <?php echo $shifts_sh ?>><TD ALIGN=LEFT <?php echo $shifts_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=130000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_shifts.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Shifts"); ?> </a></TD>
</TR><TR <?php echo $phones_sh ?>><TD ALIGN=LEFT <?php echo $phones_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=10000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_phones.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Phones"); ?> </a></TD>
</TR><TR <?php echo $templates_sh ?>><TD ALIGN=LEFT <?php echo $templates_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=130000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_templates.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Templates"); ?> </a></TD>
</TR><TR <?php echo $carriers_sh ?>><TD ALIGN=LEFT <?php echo $carriers_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=140000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_carriers.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Carriers"); ?> </a></TD>
</TR><TR <?php echo $server_sh ?>><TD ALIGN=LEFT <?php echo $server_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=100000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_servers.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Servers"); ?> </a></TD>
</TR><TR <?php echo $conference_sh ?>><TD ALIGN=LEFT <?php echo $conference_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=1000000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_conferences.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Conferences"); ?> </a></TD>
</TR><TR <?php echo $settings_sh ?>><TD ALIGN=LEFT <?php echo $settings_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=311111111111111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_settings.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("System Settings"); ?> </a></TD>
</TR><TR <?php echo $label_sh ?>><TD ALIGN=LEFT <?php echo $label_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=180000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_screenlabels.png" border=0 alt=\"Labels\" width=14 height=14 valign=middle> <?php echo _QXZ("Screen Labels"); ?> </a></TD>
</TR><TR <?php echo $colors_sh ?>><TD ALIGN=LEFT <?php echo $colors_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=182000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_screencolors.png" border=0 alt=\"Colors\" width=14 height=14 valign=middle> <?php echo _QXZ("Screen Colors"); ?> </a></TD>
</TR><TR <?php echo $status_sh ?>><TD ALIGN=LEFT <?php echo $status_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=321111111111111" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_statuses.png" border=0 alt=\"Statuses\" width=14 height=14 valign=middle> <?php echo _QXZ("System Statuses"); ?> </a></TD>
</TR><TR <?php echo $sg_sh ?>><TD ALIGN=LEFT <?php echo $sg_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=193000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_statusgroups.png" border=0 alt=\"Status Groups\" width=14 height=14 valign=middle> <?php echo _QXZ("Status Groups"); ?> </a></TD>
<?php
if ($SScampaign_cid_areacodes_enabled > 0)
{
?>
</TR><TR <?php echo $cg_sh ?>><TD ALIGN=LEFT <?php echo $cg_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=196000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_cidgroups.png" border=0 alt=\"CID Groups\" width=14 height=14 valign=middle> <?php echo _QXZ("CID Groups"); ?> </a></TD>
<?php
}
?>
</TR><TR <?php echo $vm_sh ?>><TD ALIGN=LEFT <?php echo $vm_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=170000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_voicemail.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Voicemail"); ?> </a></TD>
</TR>
<?php
if ($SSemail_enabled > 0)
{ ?>
<TR <?php echo $emails_sh ?>><TD ALIGN=LEFT <?php echo $emails_sh ?>> &nbsp; 
<a href="admin_email_accounts.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_email.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Email Accounts"); ?> </a></TD>
</TR>
<?php }
if ( ($sounds_central_control_active > 0) or ($SSsounds_central_control_active > 0) )
{ ?>
<TR <?php echo $audio_sh ?>><TD ALIGN=LEFT <?php echo $audio_sh ?>> &nbsp; 
<a href="audio_store.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_audiostore.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Audio Store"); ?> </a></TD>
</TR>
<TR <?php echo $moh_sh ?>><TD ALIGN=LEFT <?php echo $moh_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=160000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_musiconhold.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Music On Hold"); ?> </a></TD>
</TR>
<?php
if ($SSenable_languages > 0)
{
?>
<TR <?php echo $languages_sh ?>><TD ALIGN=LEFT <?php echo $languages_sh ?>> &nbsp; 
<a href="admin_languages.php?ADD=163000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_languages.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Languages"); ?> </a></TD>
</TR>
<?php
}
...
{
?>
<TR <?php echo $soundboard_sh ?>><TD ALIGN=LEFT <?php echo $soundboard_sh ?>> &nbsp; 
<a href="admin_soundboard.php?ADD=162000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_audiosoundboards.png" border=0 alt=\"Audio Soundboards\" width=14 height=14 valign=middle> <?php echo _QXZ("Audio Soundboards"); ?> </a></TD>
</TR>
<?php
}
?>
<TR <?php echo $vmmg_sh ?>><TD ALIGN=LEFT <?php echo $vmmg_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=197000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_vm_messages.png" border=0 alt=\"VM Message Groups\" width=14 height=14 valign=middle> <?php echo _QXZ("VM Message Groups"); ?> </a></TD>
</TR>
<?php
if ($SSenable_tts_integration > 0)
{
?>
<TR <?php echo $tts_sh ?>><TD ALIGN=LEFT <?php echo $tts_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=150000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_texttospeech.png" border=0 alt=\"Text To Speech\" width=14 height=14 valign=middle> <?php echo _QXZ("Text To Speech"); ?> </a></TD>
</TR>
<?php
}
...
{
?>
<TR <?php echo $cc_sh ?>><TD ALIGN=LEFT <?php echo $cc_sh ?>> &nbsp; 
<a href="callcard_admin.php" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_callcard.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("CallCard Admin"); ?> </a></TD>
</TR>
<?php
}
...
{
?>
<TR <?php echo $cts_sh ?>><TD ALIGN=LEFT <?php echo $cts_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=190000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_contacts.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Contacts"); ?> </a></TD>
</TR>
<?php
}
?>
<TR <?php echo $sc_sh ?>><TD ALIGN=LEFT <?php echo $sc_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=192000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_settingscontainer.png" border=0 alt=\"Users\" width=14 height=14 valign=middle> <?php echo _QXZ("Settings Containers"); ?> </a></TD>
</TR>
<?php
if ($SSenable_auto_reports > 0)
{
?>
<TR <?php echo $ar_sh ?>><TD ALIGN=LEFT <?php echo $ar_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=194000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_autoreports.png" border=0 alt=\"Automated Reports\" width=14 height=14 valign=middle> <?php echo _QXZ("Automated Reports"); ?> </a></TD>
</TR>
<?php
}
...
{
?>
<TR <?php echo $il_sh ?>><TD ALIGN=LEFT <?php echo $il_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=195000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_iplists.png" border=0 alt=\"IP Lists\" width=14 height=14 valign=middle> <?php echo _QXZ("IP Lists"); ?> </a></TD>
</TR>
<?php
}
?>
<TR <?php echo $qg_sh ?>><TD ALIGN=LEFT <?php echo $qg_sh ?>> &nbsp; 
<a href="<?php echo $ADMIN ?>?ADD=198000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> &nbsp; <img src="images/icon_queuegroups.png" border=0 alt=\"Queue Groups\" width=14 height=14 valign=middle> <?php echo _QXZ("Queue Groups"); ?> </a></TD>
</TR>
<?php
}
}
...
<!-- REPORTS NAVIGATION -->
<TR WIDTH=160><TD><DIV CLASS="horiz_line"></DIV></TD></TR>
<TR <?php echo $reports_hh ?>><TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=999999" class="sidebar-menu-item"><?php echo $reports_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $reports_fc ?>"><?php echo $reports_bold ?> <?php echo _QXZ("Reports"); ?> </a>
</TD></TR>
<?php
}
...
<TR <?php echo $qc_hh ?>>
<TD ALIGN=LEFT>
<a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="sidebar-menu-item"><?php echo $reports_icon ?> <FONT STYLE="font-family:HELVETICA;font-size:<?php echo $header_font_size ?>;color:<?php echo $reports_fc ?>"><?php echo $qc_bold ?> <?php echo _QXZ("Quality Control"); ?> </FONT></a>
</TD>
</TR>
<?php
if (strlen($qc_hh) > 25) 
...
<TD ALIGN=LEFT> &nbsp;
<a href="<?php echo $ADMIN ?>?ADD=100000000000000" class="sidebar-menu-item"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;color:BLACK;"> <?php echo _QXZ("Show QC Campaigns"); ?> </FONT></a>
</TD>
</TR>
<TR BGCOLOR=<?php echo $qc_color ?>>
<TD ALIGN=LEFT> &nbsp;
...
<a href="<?php echo $admin_home_url_LU ?>" class="top-link"><?php echo _QXZ("HOME"); ?></a> | 
<A HREF="../agc/timeclock.php?referrer=admin" class="top-link"><?php echo _QXZ("Timeclock"); ?></A> | 
<a href="manager_chat_interface.php" class="top-link"><?php echo _QXZ("Chat"); ?></a> | 
<a href="<?php echo $ADMIN ?>?force_logout=1" class="top-link"><?php echo _QXZ("Logout"); ?></a> 
<span class="user-info">(<?php echo $PHP_AUTH_USER ?>)</span>

<?php
if ($SSenable_languages == '1')
{
echo " | <a href=\"$ADMIN?ADD=999989\" class=\"top-link\">"._QXZ("Change language")."</a>";
}
?>
</div>
...
<a href="<?php echo $ADMIN ?>?ADD=10" class="breadcrumb-link"><?php echo _QXZ("Show Campaigns"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=11" class="breadcrumb-link"><?php echo _QXZ("Add A New Campaign"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=12" class="breadcrumb-link"><?php echo _QXZ("Copy Campaign"); ?></a>
<?php } ?>
| <a href="./AST_timeonVDADallSUMMARY.php" class="breadcrumb-link"><?php echo _QXZ("Real-Time Campaigns Summary"); ?></a>
</div>
<?php }
if ( (strlen($droplist_sh) > 25) and ($SSenable_drop_lists > 0) ) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=130" class="breadcrumb-link"><?php echo _QXZ("Show Drop Lists"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=131" class="breadcrumb-link"><?php echo _QXZ("Add A New Drop List"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=100000000" class="breadcrumb-link"><?php echo _QXZ("Show Call Times"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Call Time"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=1000000000" class="breadcrumb-link"><?php echo _QXZ("Show State Call Times"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=1111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New State Call Time"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=1200000000" class="breadcrumb-link"><?php echo _QXZ("Holidays"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=1211111111" class="breadcrumb-link"><?php echo _QXZ("Add Holiday"); ?></a>
<?php } ?>
</div>
<?php } 
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=130000000" class="breadcrumb-link"><?php echo _QXZ("Show Shifts"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=131111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Shift"); ?></a>
<?php } ?>
</div>
<?php } 
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=10000000000" class="breadcrumb-link"><?php echo _QXZ("Show Phones"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=11111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Phone"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=12222222222" class="breadcrumb-link"><?php echo _QXZ("Copy an Existing Phone"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=12000000000" class="breadcrumb-link"><?php echo _QXZ("Phone Alias List"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=12111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Phone Alias"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=13000000000" class="breadcrumb-link"><?php echo _QXZ("Group Alias List"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=13111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Group Alias"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=1000000000000" class="breadcrumb-link"><?php echo _QXZ("Show Conferences"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=1111111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Conference"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=10000000000000" class="breadcrumb-link"><?php echo _QXZ("Show VICIDIAL Conferences"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=11111111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New VICIDIAL Conference"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=12000000000000" class="breadcrumb-link"><?php echo _QXZ("Show ConfBridges"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=12111111111111" class="breadcrumb-link"><?php echo _QXZ("Add ConfBridge"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=100000000000" class="breadcrumb-link"><?php echo _QXZ("Show Servers"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=111111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Server"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=130000000000" class="breadcrumb-link"><?php echo _QXZ("Show Templates"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=131111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Template"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=140000000000" class="breadcrumb-link"><?php echo _QXZ("Show Carriers"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=141111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Carrier"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=140111111111" class="breadcrumb-link"><?php echo _QXZ("Copy A Carrier"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="admin_email_accounts.php" class="breadcrumb-link"><?php echo _QXZ("Show Email Accounts"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="admin_email_accounts.php?eact=ADD" class="breadcrumb-link"><?php echo _QXZ("Add A New Account"); ?></a>
| <a href="admin_email_accounts.php?eact=COPY" class="breadcrumb-link"><?php echo _QXZ("Copy An Account"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=150000000000" class="breadcrumb-link"><?php echo _QXZ("Show TTS Entries"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=151111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New TTS Entry"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="callcard_admin.php" class="breadcrumb-link"><?php echo _QXZ("CallCard Summary"); ?></a>
| <a href="callcard_admin.php?action=CALLCARD_RUNS" class="breadcrumb-link"><?php echo _QXZ("Runs"); ?></a>
| <a href="callcard_admin.php?action=CALLCARD_BATCHES" class="breadcrumb-link"><?php echo _QXZ("Batches"); ?></a>
| <a href="callcard_admin.php?action=SEARCH" class="breadcrumb-link"><?php echo _QXZ("CallCard Search"); ?></a>
| <a href="callcard_report_export.php" class="breadcrumb-link"><?php echo _QXZ("CallCard Log Export"); ?></a>
| <a href="callcard_admin.php?action=GENERATE" class="breadcrumb-link"><?php echo _QXZ("CallCard Generate New Numbers"); ?></a>
</div>
<?php }
if ( (strlen($moh_sh) > 25) and (strlen($admin_hh) > 25) ) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=160000000000" class="breadcrumb-link"><?php echo _QXZ("Show MOH Entries"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=161111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New MOH Entry"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="admin_languages.php?ADD=163000000000" class="breadcrumb-link"><?php echo _QXZ("Show Languages"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="admin_languages.php?ADD=163111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Language"); ?></a>
| <a href="admin_languages.php?ADD=163211111111" class="breadcrumb-link"><?php echo _QXZ("Copy A Languages Entry"); ?></a>
| <a href="admin_languages.php?ADD=163311111111" class="breadcrumb-link"><?php echo _QXZ("Import Phrases"); ?></a>
| <a href="admin_languages.php?ADD=163411111111" class="breadcrumb-link"><?php echo _QXZ("Export Phrases"); ?></a>
<?php } ?>
</div>
<?php }
if ( (preg_match("/soundboard/",$SSactive_modules) ) or ($SSagent_soundboards > 0) )
...
?>
<div class="breadcrumb">
<a href="admin_soundboard.php?ADD=162000000000" class="breadcrumb-link"><?php echo _QXZ("Show Soundboard Entries"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="admin_soundboard.php?ADD=162111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Soundboard Entry"); ?></a>
| <a href="admin_soundboard.php?ADD=162211111111" class="breadcrumb-link"><?php echo _QXZ("Copy A Soundboard Entry"); ?></a>
<?php } ?>
</div>
<?php
}
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=170000000000" class="breadcrumb-link"><?php echo _QXZ("Show Voicemail Entries"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=171111111111" class="breadcrumb-link"><?php echo _QXZ("Add A New Voicemail Entry"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=311111111111111" class="breadcrumb-link"><?php echo _QXZ("System Settings"); ?></a>
</div>
<?php }
if (strlen($label_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=180000000000" class="breadcrumb-link"><?php echo _QXZ("Screen Labels"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=181111111111" class="breadcrumb-link"><?php echo _QXZ("Add A Screen Label"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=182000000000" class="breadcrumb-link"><?php echo _QXZ("Screen Colors"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=182111111111" class="breadcrumb-link"><?php echo _QXZ("Add A Screen Colors"); ?></a>
<?php } ?>
| <a href="<?php echo $ADMIN ?>?ADD=311111111111111#screen_colors" class="breadcrumb-link"><?php echo _QXZ("Change Active Screen Colors"); ?></a>
</div>
<?php }
if (strlen($cts_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=190000000000" class="breadcrumb-link"><?php echo _QXZ("Contacts"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=191111111111" class="breadcrumb-link"><?php echo _QXZ("Add A Contact"); ?></a>
<?php } ?>
</div>
<?php }
if (strlen($sc_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=192000000000" class="breadcrumb-link"><?php echo _QXZ("Settings Containers"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=192111111111" class="breadcrumb-link"><?php echo _QXZ("Add A Settings Container"); ?></a>
<?php } ?>
</div>
<?php }
if (strlen($ar_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=194000000000" class="breadcrumb-link"><?php echo _QXZ("Automated Reports"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=194111111111" class="breadcrumb-link"><?php echo _QXZ("Add An Automated Report"); ?></a>
<?php } ?>
</div>
<?php }
if (strlen($il_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=195000000000" class="breadcrumb-link"><?php echo _QXZ("IP Lists"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=195111111111" class="breadcrumb-link"><?php echo _QXZ("Add An IP List"); ?></a>
<?php } ?>
</div>
<?php }
if (strlen($sg_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=193000000000" class="breadcrumb-link"><?php echo _QXZ("Status Groups"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=193111111111" class="breadcrumb-link"><?php echo _QXZ("Add A Status Group"); ?></a>
<?php } ?>
</div>
<?php }
if (strlen($cg_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=196000000000" class="breadcrumb-link"><?php echo _QXZ("CID Groups"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=196111111111" class="breadcrumb-link"><?php echo _QXZ("Add A CID Group"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=197000000000" class="breadcrumb-link"><?php echo _QXZ("VM Message Groups"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=197111111111" class="breadcrumb-link"><?php echo _QXZ("Add A VM Message Group"); ?></a>
<?php } ?>
</div>
<?php }
if (strlen($qg_sh) > 25) { 
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=198000000000" class="breadcrumb-link"><?php echo _QXZ("Queue Groups"); ?></a>
<?php if ($add_copy_disabled < 1) { ?>
| <a href="<?php echo $ADMIN ?>?ADD=198111111111" class="breadcrumb-link"><?php echo _QXZ("Add A Queue Group"); ?></a>
<?php } ?>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=321111111111111" class="breadcrumb-link"><?php echo _QXZ("System Statuses"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=331111111111111" class="breadcrumb-link"><?php echo _QXZ("Status Categories"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=341111111111111" class="breadcrumb-link"><?php echo _QXZ("QC Status Codes"); ?></a>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="./user_stats.php?user=<?php echo $user ?>" class="breadcrumb-link"><?php echo _QXZ("User Stats"); ?></a>
| <a href="./user_status.php?user=<?php echo $user ?>" class="breadcrumb-link"><?php echo _QXZ("User Status"); ?></a>
| <a href="./AST_agent_time_sheet.php?agent=<?php echo $user ?>" class="breadcrumb-link"><?php echo _QXZ("Time Sheet"); ?></a>
| <a href="./AST_agent_days_detail.php?user=<?php echo $user ?>" class="breadcrumb-link"><?php echo _QXZ("Days Status"); ?></a>
</div>
<?php }
...
?>
<div class="breadcrumb">
<a href="<?php echo $ADMIN ?>?ADD=999988" class="breadcrumb-link"><?php echo _QXZ("Available Timezones"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=999987" class="breadcrumb-link"><?php echo _QXZ("Phone Codes"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=999986" class="breadcrumb-link"><?php echo _QXZ("Postal Codes"); ?></a>
| <a href="<?php echo $ADMIN ?>?ADD=999985" class="breadcrumb-link"><?php echo _QXZ("Postal Codes Cities"); ?></a>
</div>
<?php 
}
else
...
?>
<div class="breadcrumb"><FONT STYLE="font-family:HELVETICA;font-size:<?php echo $subcamp_font_size ?>;"><B> &nbsp; </B></FONT></div>
<?php } 
}
?>
</div>
...
<p>&copy; <?php echo date('Y'); ?> VICIDIAL Admin Panel</p>
<p>Version: <?php echo $VICIDIAL_VERSION; ?> | Build: <?php echo $BUILD_NUMBER; ?></p>
<p>
<a href="#" onclick="window.open('view-source:' + window.location.href, '_blank'); return false;">View Source</a> | 
<a href="#" onclick="navigator.clipboard.writeText(document.documentElement.outerHTML); alert('Source code copied to clipboard!'); return false;">Copy Source</a>
</p>
</div>
</div>
