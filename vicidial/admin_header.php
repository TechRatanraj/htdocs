...
// Purple Gradient Theme + Logo-Only Navbar
// ============================================
...
// Override admin URL if set
if (isset($SSadmin_home_url) && strlen($SSadmin_home_url) > 5) {
...
<div class="navbar-container">
    <!-- Logo Only - Menus are in Left Sidebar -->
    <div class="navbar-logo">
        <a href="<?php echo htmlspecialchars($ADMIN); ?>" title="Go to Admin Home">
            <img src="<?php echo htmlspecialchars($selected_small_logo); ?>" width="71" height="22" border="0" alt="Vicidial Admin" />
        </a>
    </div>
</div>
...
<?php
// ============================================
// NOTE: Navigation menus are rendered in the left sidebar
// This navbar displays only the logo for clean UI
// ============================================
?>
